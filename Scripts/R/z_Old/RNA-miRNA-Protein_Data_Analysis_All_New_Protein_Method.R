...
miRNA_mRNA_protein_data <- 'Data/Merged/New_Protein_Method_miRNA_mRNA_Protein_Combined_Data_IMPORTANT.2024.06.27.tsv'
...
write.csv(gene_miRNA_table, 'Tables/All/New_Protein_Method_Genes_regulated_by_miRNAs_in_All_2024.06.27.csv', row.names = F)
...
# Now save that table as a csv
write.csv(venom_gene_miRNA_table, 'Tables/All/New_Protein_Method_Venom_Genes_regulated_by_miRNAs_in_All_2024.06.27.csv', row.names = F)
...
# Now save that table as a csv
write.csv(non_venom_gene_miRNA_table, 'Tables/All/New_Protein_Method_Non-Venom_Genes_regulated_by_miRNAs_in_All_2024.06.27.csv', row.names = F)
...
# Now save that table as a csv
write.csv(miRNA_gene_table, 'Tables/All/New_Protein_Method_miRNAs_in_All_and_regulated_genes_2024.06.27.csv', row.names = F)
...
write.csv(putative_miRNA_names, 'Tables/All/New_Protein_Method_Putative_miRNA_Names_2024.06.27.csv', row.names = F)
...
write.csv(venom_putative_miRNA_names, 'Tables/All/New_Protein_Method_Venom_Putative_miRNA_Names_2024.06.27.csv', row.names = F)
...
# Read mRNA data
mRNA_data <- 'Data/mRNA/New_Protein_Method_RNAseq_VST_Formated_IMPORTANT_2024.06.27.tsv'
...
ggsave('Figures/Pie_Charts/All/New_Protein_Method_Transcripome_viridis_CV0857_2024.06.27.pdf', venom_mRNA_CV0857_pie_chart, create.dir = T)
...
ggsave('Figures/Pie_Charts/All/New_Protein_Method_Transcripome_viridis_CV1087_2024.06.27.pdf', venom_mRNA_CV1087_pie_chart, create.dir = T)
...
ggsave('Figures/Pie_Charts/All/New_Protein_Method_Transcripome_viridis_CV1081_2024.06.27.pdf', venom_mRNA_CV1081_pie_chart, create.dir = T)
...
ggsave('Figures/Pie_Charts/All/New_Protein_Method_Transcripome_viridis_CV1086_2024.06.27.pdf', venom_mRNA_CV1086_pie_chart, create.dir = T)
...
ggsave('Figures/Pie_Charts/All/New_Protein_Method_Transcripome_lutosus_CV0987_2024.06.27.pdf', venom_mRNA_CV0987_pie_chart, create.dir = T)
...
ggsave('Figures/Pie_Charts/All/New_Protein_Method_Transcripome_concolor_CV0985_2024.06.27.pdf', venom_mRNA_CV0985_pie_chart, create.dir = T)
...
ggsave('Figures/Pie_Charts/All/New_Protein_Method_Proteome_lutosus_CV0987_2024.06.27.pdf', venom_protein_CV0987_pie_chart, create.dir = T)
...
ggsave('Figures/Pie_Charts/All/New_Protein_Method_Proteome_concolor_CV0985_2024.06.27.pdf', venom_protein_CV0985_pie_chart, create.dir = T)
...
ggsave('Figures/Pie_Charts/All/New_Protein_Method_Proteome_viridis_CV1087_2024.06.27.pdf', venom_protein_CV1087_pie_chart, create.dir = T)
...
ggsave('Figures/Pie_Charts/All/New_Protein_Method_Proteome_viridis_CV1086_2024.06.27.pdf', venom_protein_CV1086_pie_chart, create.dir = T)
...
ggsave('Figures/Pie_Charts/All/New_Protein_Method_Proteome_viridis_CV1081_2024.06.27.pdf', venom_protein_CV1081_pie_chart, create.dir = T)
...
ggsave('Figures/Pie_Charts/All/New_Protein_Method_Proteome_viridis_CV0857_2024.06.27.pdf', venom_protein_CV0857_pie_chart, create.dir = T)
...
miRNA_relative_frequencies <- miRNA_rpm_df %>% 
  dplyr::select(-Genes) %>% 
  distinct() %>% 
  ggplot(
    aes(x = miRNA.Cluster, y = miRNA.RPM, fill = Sample.ID)
) +
...
# Save
ggsave('Figures/Bar_Graphs/All/New_Protein_Method_miRNA_relative_frequencies_all_genes_2024.06.27.pdf', plot = miRNA_relative_frequencies, width = 10, height = 15, create.dir = T)
...
# Save
ggsave('Figures/Bar_Graphs/All/New_Protein_Method_miRNA_relative_frequencies_venom_genes_2024.06.27.pdf', plot = miRNA_relative_frequencies, width = 10, height = 15, create.dir = T)
...
miRNA_totals_plot
ggsave('Figures/Bar_Graphs/All/New_Protein_Method_miRNA_totals_per_sample_2024.06.27.pdf', plot = miRNA_totals_plot, create.dir = T)
...
all_prot_plot <- protein_only_df %>% 
  ...
  theme(legend.position = 'none')
all_prot_plot  
ggsave('Figures/Bar_Graphs/All/New_Protein_Method_Protein_totals_per_sample_2024.06.27.pdf', plot = all_prot_plot, create.dir = T)
...
mrna_data <- 'Data/mRNA/New_Protein_Method_RNAseq_Raw_Formated_IMPORTANT_2024.06.27.tsv'
...
all_mrna_plot <- mrna_only_df %>% 
  ...
  theme(legend.position = 'none')
all_mrna_plot
ggsave('Figures/Bar_Graphs/All/New_Protein_Method_mRNA_totals_per_sample_2024.06.27.pdf', plot = all_mrna_plot, create.dir = T)
...
ggsave('Figures/Expression_Plots/New_Protein_Method/All/Total_Sample_Regressions/mRNA_vs_Protein_Expression_Totals.2024.06.27.pdf', plot = mRNA_vs_protein_sum_plot, create.dir = T)
...
ggsave('Figures/Expression_Plots/New_Protein_Method/All/Total_Sample_Regressions/miRNA_vs_Protein_Expression_Totals.2024.06.27.pdf', plot = mRNA_vs_protein_sum_plot, create.dir = T)
...
ggsave('Figures/Expression_Plots/New_Protein_Method/All/Total_Sample_Regressions/miRNA_vs_Residuals_of_mRNAvsProtein_Linear_Regression.2024.06.27.pdf', plot = totals_residuals_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/New_Protein_Method/All/Linear_Regression_VST/New_Protein_Method_All_Individuals_mRNAvsProtein_Expression_Plot_2024.06.27.pdf', plot = all_gene_expression_plot, create.dir = T)
...
wider_miRNA_with_residuals_df <- miRNA_with_residuals_df %>% 
  ...
  dplyr::filter(!str_detect(Genes, 'Venom_ADAM')) %>%  # Remove ADAMs
  distinct()
...
# path <- 'Figures/Expression_Plots/New_Protein_Method/All/Linear_Regression_VST/Individual_miRNA_Gene_Relationships'

# Not going to run this since it takes to long.
# # Loop the function 
# for (gene in venom_genes) {
#   # Run the function in a loop
#   plots <- residuals_vs_miRNA_plot2(wider_miRNA_with_residuals_df, gene, path, '2024.06.27', filter_r_squared = F)
# }


# Add only the plots with R squared higher than 
# Create a second path
path2 <- 'Figures/Expression_Plots/New_Protein_Method/All/Linear_Regression_VST/Individual_miRNA_Gene_Relationships/Good_R_squared'
...
# Save 
ggsave('Figures/Expression_Plots/New_Protein_Method/All/Linear_Regression_VST/Viridis_Only_Individuals_mRNAvsProtein_Expression_Plot_2024.06.27.pdf', plot = viridis_only_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/New_Protein_Method/All/Linear_Regression_VST/CV1081_viridis_mRNAvsProtein_Expression_Plot_2024.06.27.pdf', plot = CV1081_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/New_Protein_Method/All/Linear_Regression_VST/CV0857_viridis_mRNAvsProtein_Expression_Plot_2024.06.27.pdf', plot = CV0857_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/New_Protein_Method/All/Linear_Regression_VST/CV1086_viridis_mRNAvsProtein_Expression_Plot_2024.06.27.pdf', plot = CV1086_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/New_Protein_Method/All/Linear_Regression_VST/CV1087_viridis_mRNAvsProtein_Expression_Plot_2024.06.27.pdf', plot = CV1087_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/New_Protein_Method/All/Linear_Regression_VST/CV0987_lutosus_mRNAvsProtein_Expression_Plot_2024.06.27.pdf', plot = CV0987_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/New_Protein_Method/All/Linear_Regression_VST/CV0985_concolor_mRNAvsProtein_Expression_Plot_2024.06.27.pdf', plot = CV0985_plot, create.dir = T)
...
mRNA_all_heatmap
# Save
ggsave("Figures/Heat_Maps/All/New_Protein_Method_mRNA_all_genes_All_heatmap_2024.06.27.pdf", plot = mRNA_all_heatmap, width = 18, height = 4, dpi = 900, create.dir = T)
...
all_venom_genes_mRNA_heatmap <- ggplot(all_venom_genes_mRNA_df, aes(y = Individuals, x = Genes, fill = mRNA.Expression)) +
  geom_tile() +
  scale_fill_viridis_c(option = 'magma') +
  labs(y = 'Individuals', x = 'Genes', fill = 'mRNA Expression Level', title = "mRNA Expression Level for all Targeted Venom Genes") +
  theme(axis.text.x = element_text(angle = 70, hjust = 1))
# Print
all_venom_genes_mRNA_heatmap
# Save
ggsave("Figures/Heat_Maps/All/New_Protein_Method_venom_mRNA_All_heatmap_2024.06.27.pdf", plot = all_venom_genes_mRNA_heatmap, width = 18, height = 4, dpi = 900, create.dir = T)
...
miRNA_all_heatmap
# Save
ggsave("Figures/Heat_Maps/All/New_Protein_Method_miRNA_all_3UTR_heatmap_2024.06.27.pdf", plot = miRNA_all_heatmap, width = 18, height = 4, dpi = 900, create.dir = T)
...
venom_miRNA_heatmap
# Save
ggsave("Figures/Heat_Maps/All/New_Protein_Method_venom_miRNA_3UTR_heatmap_2024.06.27.pdf", plot = venom_miRNA_heatmap, width = 18, height = 4, dpi = 900, create.dir = T)
...
protein_all_heatmap <- ggplot(protein_all_df, aes(y = Individuals, x = Genes, fill = log(Intensity + 1))) +
  geom_tile() +
  scale_fill_viridis_c(option = 'magma') +
  labs(y = 'Individuals', x = 'Proteins', fill = 'Protein Expression Level', title = "Protein Expression Level for all Targeted Genes (log scaled)") +
  theme(axis.text.x = element_text(angle = 70, hjust = 1))
protein_all_heatmap
# Save
ggsave("Figures/Heat_Maps/All/New_Protein_Method_protein_all_All_heatmap_2024.06.27.pdf", plot = protein_all_heatmap, width = 18, height = 4, dpi = 900, create.dir = T)
...
venom_protein_heatmap <- ggplot(venom_protein_df, aes(y = Individuals, x = Genes, fill = log(Intensity + 1))) +
  geom_tile() +
  scale_fill_viridis_c(option = 'magma') +
  labs(y = 'Individuals', x = 'Proteins', fill = 'Protein Expression Level', title = "Protein Expression Level for all Targeted Venom Genes") +
  theme(axis.text.x = element_text(angle = 70, hjust = 1))
venom_protein_heatmap
# Save
ggsave("Figures/Heat_Maps/All/New_Protein_Method_venom_protein_All_heatmap_2024.06.27.pdf", plot = venom_protein_heatmap, width = 18, height = 4, dpi = 900, create.dir = T)
...
pdf(file = 'Figures/CIRCOS/All/New_Protein_Method_Venom_Genes_Colored_CIRCOS_CV1087_viridis_2024.06.27.pdf', width = 10, height = 10)
...
# Begin saving the plot as a pdf
pdf(file = 'Figures/CIRCOS/All/New_Protein_Method_Venom_Genes_Colored_CIRCOS_CV0987_lutosus_2024.06.27.pdf', width = 10, height = 10)
...
# 
# # Begin saving the plot as a pdf
# pdf(file = 'Figures/CIRCOS/All/PLA_mini_CIRCOS.2024.06.27.pdf', width = 10, height = 10)
# 
# circos.clear()
# 
# # Set basic parameters for the circos plot
...
# Begin saving the plot as a pdf
pdf(file = 'Figures/CIRCOS/All/New_Protein_Method_Venom_Genes_Colored_CIRCOS_CV0985_concolor_2024.06.27.pdf', width = 10, height = 10)
...
rna_mirna_data <- 'Data/Merged/New_Protein_Method_miRNA_mRNA_Combined_Data_IMPORTANT.2024.06.27.tsv'
...
report1 <- DESeq2Report(
  ...
  author = 'Kaas Ballard',
  outdir = 'Figures/DESeq2/New_Protein_Method/All/DESeq2_miRNA-mRNA-Region_Report',
...
pca1
ggsave('Figures/DESeq2/New_Protein_Method/All/PCA/Species_DESeq_PCA.2024.06.27.pdf', pca1, create.dir = T)
...
# Run the function in a loop
for (gene in genes) {
  plot_gene_counts(dds, gene = gene, intgroup = 'species', saveDir = 'Figures/DESeq2/New_Protein_Method/All/DESeq_Counts/Species/Venom/Genes/Significant_and_Nonsignificant', date = '2024.06.27')
}
...
for (miRNA in miRNAs) {
  plot_gene_counts(dds, gene = miRNA, intgroup = 'species', saveDir = 'Figures/DESeq2/New_Protein_Method/All/DESeq_Counts/Species/Venom/miRNAs/Significant_and_Nonsignificant', date = '2024.06.27')
}
...
for (gene in sig_genes) {
  plot_gene_counts(dds, gene = gene, intgroup = 'species', saveDir = 'Figures/DESeq2/New_Protein_Method/All/DESeq_Counts/Species/Venom/Genes/Significant_Paired', date = '2024.06.27')
}
...
for (miRNA in sig_miRNAs) {
  plot_gene_counts(dds, gene = miRNA, intgroup = 'species', saveDir = 'Figures/DESeq2/New_Protein_Method/All/DESeq_Counts/Species/Venom/miRNAs/Significant_Paired', date = '2024.06.27')
}
...
# Run the function in a loop
for (gene in sig_genes) {
  plot_gene_counts(dds, gene = gene, intgroup = 'species', saveDir = 'Figures/DESeq2/New_Protein_Method/All/DESeq_Counts/Species/Venom/Genes/Significant', date = '2024.06.27')
}
...
# Run the function in a loop for the miRNAs as well
for (miRNA in sig_miRNAs) {
  plot_gene_counts(dds, gene = miRNA, intgroup = 'species', saveDir = 'Figures/DESeq2/New_Protein_Method/All/DESeq_Counts/Species/Venom/miRNAs/Significant', date = '2024.06.27')
}
...
# # Run the function in a loop
# for (gene in genes) {
#   plot_gene_counts(dds, gene = gene, intgroup = 'species', saveDir = 'Figures/DESeq2/New_Protein_Method/All/DESeq_Counts/Species/Non_Venom/Genes/Significant_and_Nonsignificant', date = '2024.06.27')
# }
...
# Run the function in a loop for the miRNAs as well
for (miRNA in miRNAs) {
  plot_gene_counts(dds, gene = miRNA, intgroup = 'species', saveDir = 'Figures/DESeq2/New_Protein_Method/All/DESeq_Counts/Species/Non_Venom/miRNAs/Significant_and_Nonsignificant', date = '2024.06.27')
}
...
# Create a new df for the genes only
non_venom_sig_genes_paired_df <- non_venom_significant_diff_paired_df %>% dplyr::select(-miRNA.Cluster, -contains('.mi')) %>% filter(!str_detect(Genes, 'maker-scaffold|augustus')) %>% distinct()
# Create a new df for the miRNAs only
...
# Run the function in a loop
for (gene in sig_genes) {
  plot_gene_counts(dds, gene = gene, intgroup = 'species', saveDir = 'Figures/DESeq2/New_Protein_Method/All/DESeq_Counts/Species/Non_Venom/Genes/Significant_Paired', date = '2024.06.27')
}
...
# Run the function in a loop for the miRNAs as well
for (miRNA in sig_miRNAs) {
  plot_gene_counts(dds, gene = miRNA, intgroup = 'species', saveDir = 'Figures/DESeq2/New_Protein_Method/All/DESeq_Counts/Species/Non_Venom/miRNAs/Significant_Paired', date = '2024.06.27')
}
...
# Create a data frame of significant venom genes (not paired)
non_venom_sig_mr_diff_df <- significant_mr_diff_df %>% filter(!str_detect(Genes, 'Venom_|PLA2GE.1')) %>% dplyr::select(-miRNA.Cluster, -contains('.mi')) %>% filter(!str_detect(Genes, 'maker-scaffold|augustus')) %>% distinct()
# Create a new df for the miRNAs only
...
# Run the function in a loop
for (gene in sig_genes) {
  plot_gene_counts(dds, gene = gene, intgroup = 'species', saveDir = 'Figures/DESeq2/New_Protein_Method/All/DESeq_Counts/Species/Non_Venom/Genes/Significant', date = '2024.06.27')
}
...
# Run the function in a loop for the miRNAs as well
for (miRNA in sig_miRNAs) {
  plot_gene_counts(dds, gene = miRNA, intgroup = 'species', saveDir = 'Figures/DESeq2/New_Protein_Method/All/DESeq_Counts/Species/Non_Venom/miRNAs/Significant', date = '2024.06.27')
}
