...
miRNA_mRNA_protein_data <- 'Data/Merged/miRNA_mRNA_Protein_Combined_Data_IMPORTANT.2024.08.14.tsv'
...
write.csv(gene_miRNA_table, 'Tables/Unfiltered/Genes_regulated_by_miRNAs_2024.08.15.csv', row.names = F)
...
# Now save that table as a csv
write.csv(venom_gene_miRNA_table, 'Tables/Unfiltered/Venom_Genes_regulated_by_miRNAs_in_3UTR_2024.08.15.csv', row.names = F)
...
# Now save that table as a csv
write.csv(non_venom_gene_miRNA_table, 'Tables/Unfiltered/Non-Venom_Genes_regulated_by_miRNAs_in_3UTR_2024.08.15.csv', row.names = F)
...
# Now save that table as a csv
write.csv(miRNA_gene_table, 'Tables/Unfiltered/miRNAs_in_3UTR_and_regulated_genes_2024.08.15.csv', row.names = F)
...
write.csv(putative_miRNA_names, 'Tables/Unfiltered/Putative_miRNA_Names_2024.08.15.csv', row.names = F)
...
write.csv(venom_putative_miRNA_names, 'Tables/Unfiltered/Venom_Putative_miRNA_Names_2024.08.15.csv', row.names = F)
...
# Read mRNA data
mRNA_data <- 'Data/mRNA/RNAseq_VST_Formated_Normalized_Counts_IMPORTANT_2024.08.14.tsv'
...
venom_mRNA_CV0857_pie_chart <- mRNA_CV0857_df %>% 
  ...
  labs(fill = 'Venom Family', title = expression(paste('Venom Transcriptome in Northern ', italic('C. viridis'), ' (CV0857)')))
venom_mRNA_CV0857_pie_chart
ggsave('Figures/Pie_Charts/Unfiltered/Transcripome_viridis_CV0857_2024.08.15.pdf', venom_mRNA_CV0857_pie_chart, create.dir = T)
...
venom_mRNA_CV1087_pie_chart <- mRNA_CV1087_df %>% 
  ...
  labs(fill = 'Venom Family', title = expression(paste('Venom Transcriptome in Northern ', italic('C. viridis'), ' (CV1087)')))
venom_mRNA_CV1087_pie_chart
ggsave('Figures/Pie_Charts/Unfiltered/Transcripome_viridis_CV1087_2024.08.15.pdf', venom_mRNA_CV1087_pie_chart, create.dir = T)
...
venom_mRNA_CV1081_pie_chart <- mRNA_CV1081_df %>% 
  ...
  labs(fill = 'Venom Family', title = expression(paste('Venom Transcriptome in Central ', italic('C. viridis'), ' (CV1081)')))
venom_mRNA_CV1081_pie_chart
ggsave('Figures/Pie_Charts/Unfiltered/Transcripome_viridis_CV1081_2024.08.15.pdf', venom_mRNA_CV1081_pie_chart, create.dir = T)
...
venom_mRNA_CV1086_pie_chart <- mRNA_CV1086_df %>% 
  ...
  labs(fill = 'Venom Family', title = expression(paste('Venom Transcriptome in Southern ', italic('C. viridis'), ' (CV1086)')))
venom_mRNA_CV1086_pie_chart
ggsave('Figures/Pie_Charts/Unfiltered/Transcripome_viridis_CV1086_2024.08.15.pdf', venom_mRNA_CV1086_pie_chart, create.dir = T)
...
venom_mRNA_CV0987_pie_chart <- mRNA_CV0987_df %>% 
  ...
  labs(fill = 'Venom Family', title = expression(paste('Venom Transcriptome in ', italic('C. lutosus'), ' (CV0987)')))
venom_mRNA_CV0987_pie_chart
ggsave('Figures/Pie_Charts/Unfiltered/Transcripome_lutosus_CV0987_2024.08.15.pdf', venom_mRNA_CV0987_pie_chart, create.dir = T)
...
venom_mRNA_CV0985_pie_chart <- mRNA_CV0985_df %>% 
  ...
  labs(fill = 'Venom Family', title = expression(paste('Venom Transcriptome in ', italic('C. concolor'), ' (CV0985)')))
venom_mRNA_CV0985_pie_chart
ggsave('Figures/Pie_Charts/Unfiltered/Transcripome_concolor_CV0985_2024.08.15.pdf', venom_mRNA_CV0985_pie_chart, create.dir = T)
...
protein_data <- 'Data/Protein/Formated_Protein_Data_IMPORTANT_2024.08.14.tsv'
...
venom_protein_CV0987_pie_chart <- prot_CV0987_df %>% 
  ...
  labs(fill = 'Venom Family', title = expression(paste('Venom Proteome in ', italic('C. lutosus'), ' (CV0987)')))
venom_protein_CV0987_pie_chart
ggsave('Figures/Pie_Charts/Unfiltered/Proteome_lutosus_CV0987_2024.08.15.pdf', venom_protein_CV0987_pie_chart, create.dir = T)
...
venom_protein_CV0985_pie_chart <- prot_CV0985_df %>% 
  ...
  labs(fill = 'Venom Family', title = expression(paste('Venom Proteome in ', italic('C. concolor'), ' (CV0985)')))
venom_protein_CV0985_pie_chart
ggsave('Figures/Pie_Charts/Unfiltered/Proteome_concolor_CV0985_2024.08.15.pdf', venom_protein_CV0985_pie_chart, create.dir = T)
...
venom_protein_CV1087_pie_chart <- prot_CV1087_df %>% 
  ...
  labs(fill = 'Venom Family', title = expression(paste('Venom Proteome in Northern ', italic('C. viridis'), ' (CV1087)')))
venom_protein_CV1087_pie_chart
ggsave('Figures/Pie_Charts/Unfiltered/Proteome_viridis_CV1087_2024.08.15.pdf', venom_protein_CV1087_pie_chart, create.dir = T)
...
venom_protein_CV1086_pie_chart <- prot_CV1086_df %>% 
  ...
  labs(fill = 'Venom Family', title = expression(paste('Venom Proteome in Southern ', italic('C. viridis'), ' (CV1086)')))
venom_protein_CV1086_pie_chart
ggsave('Figures/Pie_Charts/Unfiltered/Proteome_viridis_CV1086_2024.08.15.pdf', venom_protein_CV1086_pie_chart, create.dir = T)
...
venom_protein_CV1081_pie_chart <- prot_CV1081_df %>% 
  ...
  labs(fill = 'Venom Family', title = expression(paste('Venom Proteome in Central ', italic('C. viridis'), ' (CV1081)')))
venom_protein_CV1081_pie_chart
ggsave('Figures/Pie_Charts/Unfiltered/Proteome_viridis_CV1081_2024.08.15.pdf', venom_protein_CV1081_pie_chart, create.dir = T)
...
venom_protein_CV0857_pie_chart <- prot_CV0857_df %>% 
  ...
  labs(fill = 'Venom Family', title = expression(paste('Venom Proteome in Northern ', italic('C. viridis'), ' (CV0857)')))
venom_protein_CV0857_pie_chart
ggsave('Figures/Pie_Charts/Unfiltered/Proteome_viridis_CV0857_2024.08.15.pdf', venom_protein_CV0857_pie_chart, create.dir = T)
...
miRNA_rpm_df <- mi_df %>% 
  dplyr::select(-Origin) %>% 
  distinct() %>% # These two steps are just to save memory up front
  dplyr::select(
    miRNA.Cluster, contains('miRNA.RPM.')
  ) %>% 
  pivot_longer(
...
# Save
ggsave('Figures/Bar_Graphs/Unfiltered/miRNA_relative_frequencies_all_genes_2024.08.15.pdf', plot = miRNA_relative_frequencies, width = 10, height = 15, create.dir = T)

# Create a graph for only venom gene targeting miRNAs
miRNA_relative_frequencies_venom <- mi_df %>% 
  dplyr::select(
...
# Save
ggsave('Figures/Bar_Graphs/Unfiltered/miRNA_relative_frequencies_venom_genes_2024.08.15.pdf', plot = miRNA_relative_frequencies, width = 10, height = 15, create.dir = T)

# Create a bar graph of total miRNAs for each sample
miRNA_totals_plot <- mi_df %>% 
  dplyr::select(
    miRNA.Cluster, Genes, contains('miRNA.RPM.')
  ) %>% 
  pivot_longer(
...
miRNA_totals_plot
ggsave('Figures/Bar_Graphs/Unfiltered/miRNA_totals_per_sample_2024.08.15.pdf', plot = miRNA_totals_plot, create.dir = T)



#### Protein Expression Levels Bar Graph ####
...
all_prot_plot <- protein_only_df %>% 
  ...
  theme(legend.position = 'none')
all_prot_plot  
ggsave('Figures/Bar_Graphs/Unfiltered/Protein_totals_per_sample_2024.08.15.pdf', plot = all_prot_plot, create.dir = T)
...
mrna_data <- 'Data/mRNA/RNAseq_Raw_Formated_IMPORTANT_2024.08.14.tsv'
...
all_mrna_plot <- mrna_only_df %>% 
  ...
  theme(legend.position = 'none')
all_mrna_plot
ggsave('Figures/Bar_Graphs/Unfiltered/mRNA_totals_per_sample_2024.08.14.pdf', plot = all_mrna_plot, create.dir = T)
...
ggsave('Figures/Expression_Plots/Unfiltered/Total_Sample_Regressions/mRNA_vs_Protein_Expression_Totals.2024.08.15.pdf', plot = mRNA_vs_protein_sum_plot, create.dir = T)
...
ggsave('Figures/Expression_Plots/Unfiltered/Total_Sample_Regressions/miRNA_vs_Protein_Expression_Totals.2024.08.15.pdf', plot = mRNA_vs_protein_sum_plot, create.dir = T)
...
ggsave('Figures/Expression_Plots/Unfiltered/Total_Sample_Regressions/miRNA_vs_Residuals_of_mRNAvsProtein_Linear_Regression.2024.08.15.pdf', plot = totals_residuals_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/Unfiltered/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_2024.08.15.pdf', plot = all_gene_expression_plot, create.dir = T)
...
path <- 'Figures/Expression_Plots/Unfiltered/Linear_Regression_VST/Individual_miRNA_Gene_Relationships'

# Loop the function 
for (gene in venom_genes) {
  # Run the function in a loop
  plots <- residuals_vs_miRNA_plot2(wider_miRNA_with_residuals_df, gene, path, '2024.08.15', filter_r_squared = F)
}


# Add only the plots with R squared higher than 
# Create a second path
path2 <- 'Figures/Expression_Plots/Unfiltered/Linear_Regression_VST/Individual_miRNA_Gene_Relationships/Good_R_squared'

# Loop through the function
for (gene in venom_genes) {
  # Run the function in a loop
  plots <- residuals_vs_miRNA_plot2(wider_miRNA_with_residuals_df, gene, path2, '2024.08.15', filter_r_squared = T)
}
...
# Save 
ggsave('Figures/Expression_Plots/Unfiltered/Linear_Regression_VST/Viridis_Only_Individuals_mRNAvsProtein_Expression_Plot_2024.08.15.pdf', plot = viridis_only_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/Unfiltered/Linear_Regression_VST/CV1081_viridis_mRNAvsProtein_Expression_Plot_2024.08.15.pdf', plot = CV1081_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/Unfiltered/Linear_Regression_VST/CV0857_viridis_mRNAvsProtein_Expression_Plot_2024.08.15.pdf', plot = CV0857_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/Unfiltered/Linear_Regression_VST/CV1086_viridis_mRNAvsProtein_Expression_Plot_2024.08.15.pdf', plot = CV1086_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/Unfiltered/Linear_Regression_VST/CV1087_viridis_mRNAvsProtein_Expression_Plot_2024.08.15.pdf', plot = CV1087_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/Unfiltered/Linear_Regression_VST/CV0987_lutosus_mRNAvsProtein_Expression_Plot_2024.08.15.pdf', plot = CV0987_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/Unfiltered/Linear_Regression_VST/CV0985_concolor_mRNAvsProtein_Expression_Plot_2024.08.15.pdf', plot = CV0985_plot, create.dir = T)
...
mRNA_all_heatmap <- ggplot(mRNA_all_genes_df, aes(y = Individuals, x = Genes, fill = mRNA.Expression)) +
  ...
  theme_classic() +
  theme(axis.text.x = element_text(angle = 70, hjust = 1, size = 1))
  
# Print
mRNA_all_heatmap
# Save
ggsave("Figures/Heat_Maps/Unfiltered/mRNA_all_genes_heatmap_2024.08.15.pdf", plot = mRNA_all_heatmap, width = 18, height = 4, dpi = 900, create.dir = T)
...
# Save
ggsave("Figures/Heat_Maps/Unfiltered/Venom_mRNA_heatmap_2024.08.15.pdf", plot = all_venom_genes_mRNA_heatmap, width = 18, height = 4, dpi = 900, create.dir = T)
...
all_miRNA_df2 <- all_miRNA_df %>% dplyr::select(-Genes) %>% distinct()


# Create heat map
miRNA_all_heatmap <- ggplot(all_miRNA_df2, aes(y = Individuals, x = miRNA.Cluster, fill = log(miRNA.Expression + 1))) +
  geom_tile() +
  scale_fill_viridis_c(option = 'magma') +
...
miRNA_all_heatmap
# Save
ggsave("Figures/Heat_Maps/Unfiltered/miRNA_all_heatmap_2024.08.15.pdf", plot = miRNA_all_heatmap, width = 18, height = 4, dpi = 900, create.dir = T)

# Now for only venom
# Prepare data
venom_miRNA_df <- all_miRNA_df2 %>% 
...
venom_miRNA_heatmap
# Save
ggsave("Figures/Heat_Maps/Unfiltered/Venom_miRNA_heatmap_2024.08.15.pdf", plot = venom_miRNA_heatmap, width = 18, height = 4, dpi = 900, create.dir = T)
...
protein_all_heatmap
# Save
ggsave("Figures/Heat_Maps/Unfiltered/Protein_all_heatmap_2024.08.15.pdf", plot = protein_all_heatmap, width = 18, height = 4, dpi = 900, create.dir = T)
...
# Save
ggsave("Figures/Heat_Maps/Unfiltered/Venom_protein_heatmap_2024.08.15.pdf", plot = venom_protein_heatmap, width = 18, height = 4, dpi = 900, create.dir = T)
...
pdf(file = 'Figures/CIRCOS/Unfiltered/Venom_Genes_Colored_CIRCOS_CV1087_viridis_2024.08.15.pdf', width = 10, height = 10)
...
# Begin saving the plot as a pdf
pdf(file = 'Figures/CIRCOS/Unfiltered/Venom_Genes_Colored_CIRCOS_CV0987_lutosus_2024.08.15.pdf', width = 10, height = 10)
...
# 
# # Begin saving the plot as a pdf
# pdf(file = 'Figures/CIRCOS/3UTR/PLA_mini_CIRCOS.2024.08.15.pdf', width = 10, height = 10)
# 
# circos.clear()
# 
# # Set basic parameters for the circos plot
...
# Begin saving the plot as a pdf
pdf(file = 'Figures/CIRCOS/Unfiltered/Venom_Genes_Colored_CIRCOS_CV0985_concolor_2024.08.15.pdf', width = 10, height = 10)
...
rna_mirna_data <- 'Data/Merged/miRNA_mRNA_Combined_Data_IMPORTANT.2024.08.14.tsv'
...
report1 <- DESeq2Report(
  ...
  author = 'Kaas Ballard',
  outdir = 'Figures/DESeq2/Unfiltered/DESeq2_miRNA-mRNA-Region_Report',
...
pca1
ggsave('Figures/DESeq2/Unfiltered/PCA/Species_DESeq_PCA.2024.08.15.pdf', pca1, create.dir = T)
...
source('Scripts/R/Protein-miRNA_RNA_Analysis/Functions/Plot_Gene_Counts_Function.R')
...
# Run the function in a loop
for (gene in genes) {
  plot_gene_counts(dds, gene = gene, intgroup = 'species', saveDir = 'Figures/DESeq2/Unfiltered/DESeq_Counts/Species/Venom/Genes/Significant_and_Nonsignificant', date = '2024.08.15')
}
...
for (miRNA in miRNAs) {
  plot_gene_counts(dds, gene = miRNA, intgroup = 'species', saveDir = 'Figures/DESeq2/Unfiltered/DESeq_Counts/Species/Venom/miRNAs/Significant_and_Nonsignificant', date = '2024.08.15')
}
...
for (gene in sig_genes) {
  plot_gene_counts(dds, gene = gene, intgroup = 'species', saveDir = 'Figures/DESeq2/Unfiltered/DESeq_Counts/Species/Venom/Genes/Significant_Paired', date = '2024.08.15')
}
...
for (miRNA in sig_miRNAs) {
  plot_gene_counts(dds, gene = miRNA, intgroup = 'species', saveDir = 'Figures/DESeq2/Unfiltered/DESeq_Counts/Species/Venom/miRNAs/Significant_Paired', date = '2024.08.15')
}
...
# Run the function in a loop
for (gene in sig_genes) {
  plot_gene_counts(dds, gene = gene, intgroup = 'species', saveDir = 'Figures/DESeq2/Unfiltered/DESeq_Counts/Species/Venom/Genes/Significant', date = '2024.08.15')
}
...
# Run the function in a loop for the miRNAs as well
for (miRNA in sig_miRNAs) {
  plot_gene_counts(dds, gene = miRNA, intgroup = 'species', saveDir = 'Figures/DESeq2/Unfiltered/DESeq_Counts/Species/Venom/miRNAs/Significant', date = '2024.08.15')
}
...
# # Run the function in a loop
# for (gene in genes) {
#   plot_gene_counts(dds, gene = gene, intgroup = 'species', saveDir = 'Figures/DESeq2/New_Protein_Method/3UTR/DESeq_Counts/Species/Non_Venom/Genes/Significant_and_Nonsignificant', date = '2024.08.02')
# }
...
# Run the function in a loop for the miRNAs as well
for (miRNA in miRNAs) {
  plot_gene_counts(dds, gene = miRNA, intgroup = 'species', saveDir = 'Figures/DESeq2/Unfiltered/DESeq_Counts/Species/Non_Venom/miRNAs/Significant_and_Nonsignificant', date = '2024.08.15')
}
...
# Create a new df for the genes only
non_venom_sig_genes_paired_df <- non_venom_significant_diff_paired_df %>% dplyr::select(-miRNA.Cluster, -contains('.mi')) %>% filter(!str_detect(Genes, 'maker-scaffold')) %>% distinct()
# Create a new df for the miRNAs only
...
# Run the function in a loop
for (gene in sig_genes) {
  plot_gene_counts(dds, gene = gene, intgroup = 'species', saveDir = 'Figures/DESeq2/Unfiltered/DESeq_Counts/Species/Non_Venom/Genes/Significant_Paired', date = '2024.08.15')
}
...
# Run the function in a loop for the miRNAs as well
for (miRNA in sig_miRNAs) {
  plot_gene_counts(dds, gene = miRNA, intgroup = 'species', saveDir = 'Figures/DESeq2/Unfiltered/DESeq_Counts/Species/Non_Venom/miRNAs/Significant_Paired', date = '2024.08.15')
}
...
# Run the function in a loop
for (gene in sig_genes) {
  plot_gene_counts(dds, gene = gene, intgroup = 'species', saveDir = 'Figures/DESeq2/Unfiltered/DESeq_Counts/Species/Non_Venom/Genes/Significant', date = '2024.08.15')
}
...
# Run the function in a loop for the miRNAs as well
for (miRNA in sig_miRNAs) {
  plot_gene_counts(dds, gene = miRNA, intgroup = 'species', saveDir = 'Figures/DESeq2/Unfiltered/DESeq_Counts/Species/Non_Venom/miRNAs/Significant', date = '2024.08.15')
}


# The below does not work because the data doesn't fit certain model assumptions
...
# # Set and read the data
# protein_data <- 'Data/Protein/New_Protein_Method_Formated_Protein_Data_IMPORTANT_2024.06.27.tsv'
# protein_df <- read.table(file = protein_data, header = T) %>% 
#   dplyr::rename('Genes' = 'Converted.Gene.IDs') %>%
#   filter(Feature == 'Intensity') %>% 
#   dplyr::select(Intensity, Sample.ID, Genes) %>% 
