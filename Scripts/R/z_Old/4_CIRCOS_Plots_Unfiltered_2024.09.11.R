...
mi_df <- miRNA_mRNA_protein_df %>% 
  ...
  filter(!str_detect(Genes, 'maker-scaffold|augustus|XP_|Venom_ADAM')) %>% # This should get rid of all of the weirdly annotated genes
...
pdf(file = 'Figures/CIRCOS/Unfiltered/Venom_Genes_Colored_CIRCOS_CV1087_viridis_2024.09.02.pdf', width = 10, height = 10)
...
# Begin saving the plot as a pdf
pdf(file = 'Figures/CIRCOS/Unfiltered/Venom_Genes_Colored_CIRCOS_CV0987_lutosus_2024.09.02.pdf', width = 10, height = 10)
...
# Begin saving the plot as a pdf
pdf(file = 'Figures/CIRCOS/Unfiltered/Venom_Genes_Colored_CIRCOS_CV0985_concolor_2024.09.02.pdf', width = 10, height = 10)
...
# Begin saving the plot as a pdf
pdf(file = 'Figures/CIRCOS/Unfiltered/All_Samples_CIRCOS_2024.09.11.pdf', width = 10, height = 10)
