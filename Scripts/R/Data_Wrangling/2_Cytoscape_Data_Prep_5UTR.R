...
mi_df <- miRNA_mRNA_protein_df %>% 
  ...
  filter(Origin == 'five_prime_utr') %>% # Filter out everything not targeting the 3' UTR
...
# Save the file
write.table(edge_venom_miRNA_cytoscape_df, file = 'Data/Cytoscape/5UTR/Edge_Cytoscape_miRNA_Venom_interaction_Data.2024.10.22.tsv', sep = '\t', quote = FALSE, row.names = F)
...
# Save the file
write.table(node_venom_miRNA_cytoscape_df, file = 'Data/Cytoscape/5UTR/Node_Cytoscape_miRNA_Venom_interaction_Data.2024.10.22.tsv', sep = '\t', quote = FALSE, row.names = F)
...
classic_families_cytoscape_df <- mi_df %>% 
  ...
  mutate(miRNA_ID = str_replace_all(miRNA_ID, '_', ' '))
# Save the file
write.table(classic_families_cytoscape_df, file = 'Data/Cytoscape/5UTR/Edge_Cytoscape_miRNA_Classic_Families_interaction_Data.2024.10.22.tsv', sep = '\t', quote = FALSE, row.names = F)
...
SVMP_miRNA_cytoscape_df <- mi_df %>% 
  ...
  mutate(miRNA_ID = str_replace_all(miRNA_ID, '_', ' '))
# Save the file
write.table(SVMP_miRNA_cytoscape_df, file = 'Data/Cytoscape/5UTR/Edge_Cytoscape_miRNA_SVMP_interaction_Data.2024.10.22.tsv', sep = '\t', quote = FALSE, row.names = F)
...
SVSP_miRNA_cytoscape_df <- mi_df %>% 
  ...
  mutate(miRNA_ID = str_replace_all(miRNA_ID, '_', ' '))
# Save the file
write.table(SVSP_miRNA_cytoscape_df, file = 'Data/Cytoscape/5UTR/Edge_Cytoscape_miRNA_SVSP_interaction_Data.2024.10.22.tsv', sep = '\t', quote = FALSE, row.names = F)
...
PLA2_miRNA_cytoscape_df <- mi_df %>% 
  ...
  mutate(miRNA_ID = str_replace_all(miRNA_ID, '_', ' '))
# Save the file
write.table(PLA2_miRNA_cytoscape_df, file = 'Data/Cytoscape/5UTR/Edge_Cytoscape_miRNA_PLA2_interaction_Data.2024.10.22.tsv', sep = '\t', quote = FALSE, row.names = F)
...
nonvenom_miRNA_cytoscape_df <- mi_df %>% 
  ...
  mutate(miRNA_ID = str_replace_all(miRNA_ID, '_', ' '))
# Save the file
write.table(nonvenom_miRNA_cytoscape_df, file = 'Data/Cytoscape/5UTR/Edge_Cytoscape_miRNA_Non-Venom_interaction_Data.2024.10.22.tsv', sep = '\t', quote = FALSE, row.names = F)
