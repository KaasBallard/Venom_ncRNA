...
# Write the file
write_csv(target_by_type_df, file = 'Tables/miRNAs_and_Targets/Venom_gene_targeting_by_region_2025.04.29.csv')
...
write_csv(target_counts_df, file = 'Tables/miRNAs_and_Targets/Venom_gene_targeted_by_miRNAs_fraction_2025.04.29.csv')
