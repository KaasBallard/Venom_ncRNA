...
filtered_edge_venom_miRNA_cytoscape_df <- mi_df %>% 
  ...
  mutate(miRNA_ID = str_replace_all(miRNA_ID, '_', ' '))
# Save the file
write.table(filtered_edge_venom_miRNA_cytoscape_df, file = 'Data/Cytoscape/3UTR/Filtered_Edge_Cytoscape_miRNA_Venom_interaction_Data.2025.03.23.tsv', sep = '\t', quote = FALSE, row.names = F)
...
# Save the file
write.table(filtered_node_venom_miRNA_cytoscape_df, file = 'Data/Cytoscape/3UTR/Filtered_Node_Cytoscape_miRNA_Venom_interaction_Data.2025.03.23.tsv', sep = '\t', quote = FALSE, row.names = F)
