...
saveRDS(venom_model8.3, file = "Data/Models/venom_model8.3_from_brms_2024.10.25.rds")

# Load the saved model
venom_model8.3 <- readRDS("Data/Models/venom_model8.3_from_brms_2024.10.25.rds")
