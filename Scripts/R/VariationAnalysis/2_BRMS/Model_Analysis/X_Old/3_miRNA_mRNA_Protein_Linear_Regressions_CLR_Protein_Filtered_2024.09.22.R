...
# Save 
ggsave('Figures/Expression_Plots/CLR_Only_Observed_Proteins/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_2024.09.22.pdf', plot = all_gene_expression_plot, create.dir = T)
...
path <- 'Figures/Expression_Plots/CLR_Only_Observed_Proteins/Linear_Regression_VST/x_Individual_miRNA_Gene_Relationships'
...
path2 <- 'Figures/Expression_Plots/CLR_Only_Observed_Proteins/Linear_Regression_VST/x_Individual_miRNA_Gene_Relationships/Good_R_squared'
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    ...
    residuals_vs_miRNA_plot2(wider_miRNA_with_residuals_df, gene, path, '2024.09.22', filter_r_squared = FALSE)
    gc()
  }
}, mc.cores = num_cores)
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    # Run your plot function for each gene
    residuals_vs_miRNA_plot2(wider_miRNA_with_residuals_df, gene, path2, '2024.09.22', filter_r_squared = TRUE)
    gc()
  }
}, mc.cores = num_cores)
...
# # ggsave("Figures/Expression_Plots/Figures/Expression_Plots/CLR_Only_Observed_Proteins/Bubble_Plot/Residuals_and_miRNA_Expression_2024.09.22.pdf", plot = residuals_mirna_expression_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/CLR_Only_Observed_Proteins/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Energy_vs_RSquared_Regressions_2024.09.22.pdf", plot = be_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/CLR_Only_Observed_Proteins/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Energy_vs_RSquared_Regressions_2024.09.22.pdf", plot = be_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, limitsize = F, create.dir = T)
...
ggsave("Figures/Expression_Plots/CLR_Only_Observed_Proteins/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Score_vs_RSquared_Regressions_2024.09.22.pdf", plot = bs_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/CLR_Only_Observed_Proteins/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Score_vs_RSquared_Regressions_2024.09.22.pdf", plot = bs_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/CLR_Only_Observed_Proteins/Bubble_Plot/RSquared_and_Binding_Score_2024.09.22.pdf", plot = r_squared_binding_score_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/CLR_Only_Observed_Proteins/Bubble_Plot/RSquared_and_Binding_Energy_2024.09.22.pdf", plot = r_squared_binding_energy_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/CLR_Only_Observed_Proteins/Bubble_Plot/Filtered_RSquared_and_Binding_Energy_2024.09.22.pdf", plot = filtered_r_squared_binding_energy_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/CLR_Only_Observed_Proteins/Bubble_Plot/Filtered_RSquared_and_Binding_Score_2024.09.22.pdf", plot = filtered_r_squared_binding_score_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
R_squared_heatmap
ggsave("Figures/Expression_Plots/CLR_Only_Observed_Proteins/Heatmaps/Filtered_RSquared_Heatmap_(BS=160_BE=-20)_2024.09.22.pdf", plot = R_squared_heatmap, width = 10, height = 15, dpi = 900, create.dir = T)
...
write.csv(max_scores_df2, 'Tables/Expression_Tables/CLR_Only_Observed_Proteins/Top30_Best_miRNA-Gene_Pairs_2024.09.22.csv', row.names = F)
...
ggsave("Figures/Expression_Plots/CLR_Only_Observed_Proteins/Heatmaps/Filtered_RSquared_Heatmap_Best_30_2024.09.22.pdf", plot = R_squared_heatmap_best_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/CLR_Only_Observed_Proteins/Bubble_Plot/Top30_RSquared_and_Binding_Score_2024.09.22.pdf", plot = r_squared_binding_score_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/CLR_Only_Observed_Proteins/Bubble_Plot/Top30_RSquared_and_Binding_Energy_2024.09.22.pdf", plot = r_squared_binding_energy_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/CLR_Only_Observed_Proteins/Linear_Regression_VST/Viridis_Only_Individuals_mRNAvsProtein_Expression_Plot_2024.09.22.pdf', plot = viridis_only_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/CLR_Only_Observed_Proteins/Linear_Regression_VST/CV1081_viridis_mRNAvsProtein_Expression_Plot_2024.09.22.pdf', plot = CV1081_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/CLR_Only_Observed_Proteins/Linear_Regression_VST/CV0857_viridis_mRNAvsProtein_Expression_Plot_2024.09.22.pdf', plot = CV0857_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/CLR_Only_Observed_Proteins/Linear_Regression_VST/CV1086_viridis_mRNAvsProtein_Expression_Plot_2024.09.22.pdf', plot = CV1086_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/CLR_Only_Observed_Proteins/Linear_Regression_VST/CV1087_viridis_mRNAvsProtein_Expression_Plot_2024.09.22.pdf', plot = CV1087_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/CLR_Only_Observed_Proteins/Linear_Regression_VST/CV0987_lutosus_mRNAvsProtein_Expression_Plot_2024.09.22.pdf', plot = CV0987_plot, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/CLR_Only_Observed_Proteins/Linear_Regression_VST/CV0985_concolor_mRNAvsProtein_Expression_Plot_2024.09.22.pdf', plot = CV0985_plot, create.dir = T)
