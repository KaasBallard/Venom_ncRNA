...
ggsave('Figures/Expression_Plots/Qualitative_Analysis/Dotplots/miRNA_mRNA_protein_analysis_2024.12.8.pdf', plot = mirna_mrna_protein_color_plot, height = 15, width = 20, create.dir = T)
...
be_bs_m_mi_p_plot <- ggplot(
  ...
  facet_wrap( ~ Genes)
be_bs_m_mi_p_plot
ggsave('Figures/Expression_Plots/Qualitative_Analysis/Dotplots/Filtered_miRNA_mRNA_protein_analysis_2024.12.8.pdf', plot = be_bs_m_mi_p_plot, height = 15, width = 20, create.dir = T)
...
mirna_count_plot
ggsave('Figures/Expression_Plots/Qualitative_Analysis/Dotplots/miRNA_Numbers_vs_mean_mRNA_expression_2024.12.8.pdf', plot = mirna_count_plot, height = 15, width = 20, create.dir = T)
...
mirna_count_plot2
ggsave('Figures/Expression_Plots/Qualitative_Analysis/Dotplots/miRNA_Numbers_vs_variance_in_mRNA_expression_2024.12.8.pdf', plot = mirna_count_plot2, height = 15, width = 20, create.dir = T)
...
mirna_gene_expression_df <- left_join(
  ...
  # # Filter out Venom Genes not targeted by miRNAs
  # filter(!(Total.miRNA.Expression == 0))
  

# Create plot of mean mRNA and mean protein expression
mirna_total_plot <- ggplot(
  data = mirna_gene_expression_df,
  mapping = aes(x = log10(Total.miRNA.Expression + 1), y = Mean.mRNA.Exp)
) +
  geom_point(
    aes(
      color = log(Mean.Prot.Exp + 1),
...
mirna_total_plot
ggsave('Figures/Expression_Plots/Qualitative_Analysis/Dotplots/miRNA_total_expression_vs_mean_mRNA_expression_2024.12.8.pdf', plot = mirna_total_plot, height = 15, width = 20, create.dir = T)
...
mirna_total_plot2
ggsave('Figures/Expression_Plots/Qualitative_Analysis/Dotplots/miRNA_total_expression_vs_variance_in_mRNA_2024.12.8.pdf', plot = mirna_total_plot2, height = 15, width = 20, create.dir = T)
...
ggsave('Figures/Expression_Plots/Qualitative_Analysis/Boxplots/Number_of_miRNAs_against_mRNA_expression_2024.12.8.pdf', plot = mirna_count_mrna_comparison_boxplot, height = 10, width = 8, create.dir = T)
...
mirna_mean_ci_plot <- ggplot(mirna_mean_ci, aes(x = Bin, y = Mean, color = Bin)) +
  ...
  theme_linedraw()
mirna_mean_ci_plot
ggsave('Figures/Expression_Plots/Qualitative_Analysis/Boxplots/Number_of_miRNAs_against_mRNA_expression2_2024.12.8.pdf', plot = mirna_mean_ci_plot, height = 10, width = 8, create.dir = T)
...
ggsave('Figures/Expression_Plots/Qualitative_Analysis/Boxplots/Number_of_miRNAs_against_Protein_expression_2024.12.8.pdf', plot = mirna_count_prot_comparison_boxplot, height = 10, width = 8, create.dir = T)
...
mirna_mrna_prot_expression_df <- mi_df %>% 
  ...
  # Make genes that don't have any miRNA expression have zero values
  mutate(miRNA.VST = if_else(is.na(miRNA.VST), 0, miRNA.VST))
...
ggsave('Figures/Expression_Plots/Qualitative_Analysis/Boxplots/miRNA_expression_against_mRNA_expression_2024.12.8.pdf', plot = mirna_expression_mrna_comparison_boxplot, height = 10, width = 8, create.dir = T)
...
ggsave('Figures/Expression_Plots/Qualitative_Analysis/Boxplots/miRNA_expression_against_protein_expression_2024.12.8.pdf', plot = mirna_expression_protein_comparison_boxplot, height = 10, width = 8, create.dir = T)
