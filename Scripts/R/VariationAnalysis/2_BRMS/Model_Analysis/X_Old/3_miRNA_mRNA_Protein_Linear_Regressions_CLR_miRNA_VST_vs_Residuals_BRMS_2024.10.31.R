...
# CLR file
clr_data <- 'Data/CLR_transformed_data/CLR_mRNA_vs_protein_expression_2024.10.30.csv'

# miRNA, mRNA, protein file
mirna_mrna_protein_file <- 'Data/miRNA/miRNA_mRNA_protein_data_for_regression_analysis_2024.10.30.csv'
...
venom_model8.1 <- readRDS("Data/Models/venom_model8.1_with_5e+06_iterations_from_brms_2024.10.30.rds")
venom_model8.2 <- readRDS("Data/Models/venom_model8.2_with_5e+05_iterations_from_brms_2024.10.30.rds")
venom_model8.3 <- readRDS("Data/Models/venom_model8.3_with_50000_iterations_from_brms_2024.10.30.rds")
venom_model8.4 <- readRDS("Data/Models/venom_model8.4_with_5000_iterations_from_brms_2024.10.30.rds")
venom_model8.5 <- readRDS("Data/Models/venom_model8.5_with_500_iterations_from_brms_2024.10.30.rds")
...
# Model summary
venom_model8.1_summary <- summary(venom_model8.1)
venom_model8.1_summary
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model8.1_brm_epred_2024.10.29.pdf', plot = all_gene_expression_plot_brm_epred, height = 15, width = 20, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8.1_brm_epred_2024.10.29.pdf', plot = all_gene_expression_plot_brm_epred2, height = 15, width = 20, create.dir = T)
...
# anim_save('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8.1_brm_epred_animated_2024.10.29.gif', animation = all_gene_expression_plot_brm_epred4, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_With_BRM_Epred_Method_venom_model8.1_2024.10.29.pdf', plot = all_gene_expression_epred_plot, height = 15, width = 20, create.dir = T)

# Add facet wrap
all_gene_expression_epred_plot2 <- all_gene_expression_epred_plot + facet_wrap(~ Venom.Family)
all_gene_expression_epred_plot2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_With_BRM_Epred_Method_Separated_by_Venom_Family_venom_model8.1_2024.10.29.pdf', plot = all_gene_expression_epred_plot2, height = 15, width = 20, create.dir = T)
...
all_gene_expression_mean_epred_plot <- ggplot(data = all_samples_clr_df, aes(x = CLR.Scaled.mRNA.Expression, y = CLR.Scaled.Protein.Expression, color = Venom.Family)) +
  ...
  geom_line(data = tidy_clr_mean_epred_df, aes(y = mean.epred), linewidth = 0.5, linetype = 'solid', show.legend = F) +  # Add mean predicted lines
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_With_BRM_Mean_Epred_Method_venom_model8.1_2024.10.29.pdf', plot = all_gene_expression_mean_epred_plot, height = 15, width = 20, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_With_BRM_Mean_Epred_Method_Separated_by_Venom_Family_venom_model8.1_2024.10.29.pdf', plot = all_gene_expression_mean_epred_plot2, height = 15, width = 20, create.dir = T)




# Calculate marginal means for Venom.Family
venom_family_marginal_means <- emmeans(venom_model8.1, ~ Venom.Family)
venom_family_marginal_means

# Convert to a data frame for plotting
venom_family_marginal_means_df <- as.data.frame(venom_family_marginal_means)

# Plot the marginal means with confidence intervals
marginal_means_plot <- ggplot(venom_family_marginal_means_df, aes(x = Venom.Family, y = emmean, color = Venom.Family)) +
  geom_point(size = 3) +
  geom_errorbar(aes(ymin = lower.HPD, ymax = upper.HPD), width = 0.2) +
  labs(
    title = "Marginal Means of Protein Expression by Venom Family",
    x = "Venom Family",
    y = "Estimated Marginal Mean of Protein Expression",
    color = "Venom Family"
  ) +
  theme_linedraw() +
  theme(
  ...
  scale_color_manual(values = venom_colors)  # Use your custom colors for consistency
marginal_means_plot
...
# Save
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_microRNAvsProtein_Expression_Plot_2024.10.29.pdf', plot = Venom_Family_Specific_expression_plot, create.dir = T)
...
#  plots <- residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path, '2024.10.29', filter_r_squared = F)
# }
...
# for (gene in venom_genes) {
#  # Run the function in a loop
#  plots <- residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path2, '2024.10.29', filter_r_squared = T)
# }
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    ...
    residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path, '2024.10.29', filter_r_squared = FALSE)
    gc()
  }
}, mc.cores = num_cores)
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    # Run your plot function for each gene
    residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path2, '2024.10.29', filter_r_squared = TRUE)
    gc()
  }
}, mc.cores = num_cores)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Energy_vs_RSquared_Regressions_2024.10.29.pdf", plot = be_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Energy_vs_RSquared_Regressions_2024.10.29.pdf", plot = be_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, limitsize = F, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Score_vs_RSquared_Regressions_2024.10.29.pdf", plot = bs_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Score_vs_RSquared_Regressions_2024.10.29.pdf", plot = bs_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/RSquared_and_Binding_Score_2024.10.29.pdf", plot = r_squared_binding_score_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/RSquared_and_Binding_Energy_2024.10.29.pdf", plot = r_squared_binding_energy_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Filtered_RSquared_and_Binding_Energy_2024.10.29.pdf", plot = filtered_r_squared_binding_energy_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Filtered_RSquared_and_Binding_Score_2024.10.29.pdf", plot = filtered_r_squared_binding_score_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
R_squared_heatmap
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Heatmaps/Filtered_RSquared_Heatmap_(BS=160_BE=-20)_2024.10.29.pdf", plot = R_squared_heatmap, width = 10, height = 15, dpi = 900, create.dir = T)
...
write_csv3(max_scores_df2, file = 'Tables/Expression_Tables/Venom_Family_Specific_BRM/Top30_Best_miRNA-Gene_Pairs_2024.10.29.csv')
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Heatmaps/Filtered_RSquared_Heatmap_Best_30_2024.10.29.pdf", plot = R_squared_heatmap_best_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Top30_RSquared_and_Binding_Score_2024.10.29.pdf", plot = r_squared_binding_score_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Top30_RSquared_and_Binding_Energy_2024.10.29.pdf", plot = r_squared_binding_energy_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_vs_Protein/Linear_Regression_VST/Viridis_Only_Individuals_mRNAvsProtein_Expression_Plot_2024.10.29.pdf', plot = viridis_only_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_vs_Protein/Linear_Regression_VST/CV1081_viridis_mRNAvsProtein_Expression_Plot_2024.10.29.pdf', plot = CV1081_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_vs_Protein/Linear_Regression_VST/CV0857_viridis_mRNAvsProtein_Expression_Plot_2024.10.29.pdf', plot = CV0857_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_vs_Protein/Linear_Regression_VST/CV1086_viridis_mRNAvsProtein_Expression_Plot_2024.10.29.pdf', plot = CV1086_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_vs_Protein/Linear_Regression_VST/CV1087_viridis_mRNAvsProtein_Expression_Plot_2024.10.29.pdf', plot = CV1087_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_vs_Protein/Linear_Regression_VST/CV0987_lutosus_mRNAvsProtein_Expression_Plot_2024.10.29.pdf', plot = CV0987_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_vs_Protein/Linear_Regression_VST/CV0985_concolor_mRNAvsProtein_Expression_Plot_2024.10.29.pdf', plot = CV0985_plot, create.dir = T)
...
# Didn't work... at all
# Zero correlation
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_vs_Protein/Linear_Regression_VST/All_Individuals_mRNAvsmicroRNA_Expression_Plot_2024.10.29.pdf', plot = miRNA_vs_mRNA_all_samples_plot, create.dir = T)
...
figure_6
# ggsave("Figures/1_Main_Figures/Figure_6/Figure_6_2024.10.29.pdf", plot = figure_6, width = 18, height = 30, dpi = 2400, create.dir = T)
