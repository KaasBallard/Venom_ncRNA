...
venom_model8 <- readRDS("Data/Models/venom_model8_from_brms_2024.10.25.rds")
...
# Save
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model8_brm_2024.10.25.pdf', plot = all_gene_expression_plot_brm, height = 10, width = 10, create.dir = T)

# Add facet grid
all_gene_expression_plot_brm2 <- all_gene_expression_plot_brm + facet_wrap(~ Venom.Family)
all_gene_expression_plot_brm2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8_brm_2024.10.25.pdf', plot = all_gene_expression_plot_brm2, height = 15, width = 20, create.dir = T)
...
all_samples_clr_brm_epred_df <- all_samples_clr_df %>%
  ...
  tidybayes::add_epred_draws(venom_model8, ndraws = ndraws1)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model8_brm_epred_2024.10.25.pdf', plot = all_gene_expression_plot_brm_epred, height = 15, width = 20, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8_brm_epred_2024.10.25.pdf', plot = all_gene_expression_plot_brm_epred2, height = 15, width = 20, create.dir = T)
...
# anim_save('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8_brm_epred_animated_2024.10.25.gif', animation = all_gene_expression_plot_brm_epred4, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model8_brm_prediction_2024.10.25.pdf', plot = all_gene_expression_plot_brm_pred, height = 15, width = 20, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8_brm_prediction_2024.10.25.pdf', plot = all_gene_expression_plot_brm_pred2, height = 15, width = 20, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model8_brm_mean_prediction_2024.10.25.pdf', plot = all_gene_expression_plot_brm_mean_pred, height = 15, width = 20, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8_brm_mean_prediction_2024.10.25.pdf', plot = all_gene_expression_plot_brm_mean_pred2, height = 15, width = 20, create.dir = T)
