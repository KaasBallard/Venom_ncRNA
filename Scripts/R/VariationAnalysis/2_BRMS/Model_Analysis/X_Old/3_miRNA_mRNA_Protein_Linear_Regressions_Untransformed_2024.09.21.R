...
# Apparently zero values are not treated properly by the clr transform, so I am going to use untransformed data.

# Calculate transformed protein data
# all_samples_transformed_df <- all_samples_plot_df %>%
  # group_by(Sample.ID) %>%
  # Log scale intensity so that we get some reasonable numbers
  ...
  # mutate(Intensity = as.numeric(compositions::clr(Scaled.Protein.Expression))) %>%
  # mutate(RNA.VST = as.numeric(compositions::clr(Scaled.mRNA.Expression)))


# Set variables for protein and RNA expression levels
all_mRNA_expression <- all_samples_plot_df$RNA.VST
all_protein_expression <- all_samples_plot_df$Intensity
venom_family <- all_samples_plot_df$Venom.Family
# gene_label <- all_samples_plot_df$Genes
...
venom_lm <- lm(all_protein_expression ~ all_mRNA_expression - 1, data = all_samples_plot_df)
venom_slope <- coef(venom_lm)[2]
venom_intercept <- coef(venom_lm)[1]

# Create figure for mRNA and Protein expression
all_gene_expression_plot <- all_samples_plot_df %>% 
  ggplot(aes(x = RNA.VST, y = Intensity)) +
...
# Save
ggsave('Figures/Expression_Plots/Untransformed/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_2024.09.21.pdf', plot = all_gene_expression_plot, create.dir = T)
...
all_samples_residuals_df <- all_samples_plot_df %>% 
...
path <- 'Figures/Expression_Plots/Untransformed/Linear_Regression_VST/x_Individual_miRNA_Gene_Relationships'

# # Loop the function 
# for (gene in venom_genes) {
#  # Run the function in a loop
#  plots <- residuals_vs_miRNA_plot2(wider_miRNA_with_residuals_df, gene, path, '2024.09.21', filter_r_squared = F)
# }


# Add only the plots with R squared higher than 
# Create a second path
path2 <- 'Figures/Expression_Plots/Untransformed/Linear_Regression_VST/x_Individual_miRNA_Gene_Relationships/Good_R_squared'

# # Loop through the function
# for (gene in venom_genes) {
#  # Run the function in a loop
#  plots <- residuals_vs_miRNA_plot2(wider_miRNA_with_residuals_df, gene, path2, '2024.09.21', filter_r_squared = T)
# }
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    ...
    residuals_vs_miRNA_plot2(wider_miRNA_with_residuals_df, gene, path, '2024.09.21', filter_r_squared = FALSE)
    gc()
  }
}, mc.cores = num_cores)
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    # Run your plot function for each gene
    residuals_vs_miRNA_plot2(wider_miRNA_with_residuals_df, gene, path2, '2024.09.21', filter_r_squared = TRUE)
    gc()
  }
}, mc.cores = num_cores)
...
# # ggsave("Figures/Expression_Plots/Figures/Expression_Plots/Untransformed/Bubble_Plot/Residuals_and_miRNA_Expression_2024.09.21.pdf", plot = residuals_mirna_expression_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Untransformed/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Energy_vs_RSquared_Regressions_2024.09.21.pdf", plot = be_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Untransformed/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Energy_vs_RSquared_Regressions_2024.09.21.pdf", plot = be_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, limitsize = F, create.dir = T)
...
ggsave("Figures/Expression_Plots/Untransformed/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Score_vs_RSquared_Regressions_2024.09.21.pdf", plot = bs_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Untransformed/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Score_vs_RSquared_Regressions_2024.09.21.pdf", plot = bs_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Untransformed/Bubble_Plot/RSquared_and_Binding_Score_2024.09.21.pdf", plot = r_squared_binding_score_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Untransformed/Bubble_Plot/RSquared_and_Binding_Energy_2024.09.21.pdf", plot = r_squared_binding_energy_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Untransformed/Bubble_Plot/Filtered_RSquared_and_Binding_Energy_2024.09.21.pdf", plot = filtered_r_squared_binding_energy_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Untransformed/Bubble_Plot/Filtered_RSquared_and_Binding_Score_2024.09.21.pdf", plot = filtered_r_squared_binding_score_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
R_squared_heatmap
ggsave("Figures/Expression_Plots/Untransformed/Heatmaps/Filtered_RSquared_Heatmap_(BS=160_BE=-20)_2024.09.21.pdf", plot = R_squared_heatmap, width = 10, height = 15, dpi = 900, create.dir = T)
...
write.csv(max_scores_df2, 'Tables/Expression_Tables/Untransformed/Top30_Best_miRNA-Gene_Pairs_2024.09.21.csv', row.names = F)
...
ggsave("Figures/Expression_Plots/Untransformed/Heatmaps/Filtered_RSquared_Heatmap_Best_30_2024.09.21.pdf", plot = R_squared_heatmap_best_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Untransformed/Bubble_Plot/Top30_RSquared_and_Binding_Score_2024.09.21.pdf", plot = r_squared_binding_score_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Untransformed/Bubble_Plot/Top30_RSquared_and_Binding_Energy_2024.09.21.pdf", plot = r_squared_binding_energy_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
viridis_plot_df <- all_samples_plot_df %>% 
  filter(str_detect(Sample.ID, '.viridis.'))


# Set variables for protein and RNA expression levels
viridis_mRNA_expression <- viridis_plot_df$RNA.VST
viridis_protein_expression <- viridis_plot_df$Intensity
...
# Save 
ggsave('Figures/Expression_Plots/Untransformed/Linear_Regression_VST/Viridis_Only_Individuals_mRNAvsProtein_Expression_Plot_2024.09.21.pdf', plot = viridis_only_plot, create.dir = T)
...
# Create new data frame for only the viridis samples
CV1081_df <- all_samples_plot_df %>% 
  filter(str_detect(Sample.ID, 'LVG.2.'))


# Set variables for protein and RNA expression levels
mRNA_expression <- CV1081_df$RNA.VST
protein_expression <- CV1081_df$Intensity
...
# Save 
ggsave('Figures/Expression_Plots/Untransformed/Linear_Regression_VST/CV1081_viridis_mRNAvsProtein_Expression_Plot_2024.09.21.pdf', plot = CV1081_plot, create.dir = T)


#### mRNA vs Protein for CV0857 (viridis) ####

# Create new data frame for only the viridis samples
CV0857_df <- all_samples_plot_df %>% 
  filter(str_detect(Sample.ID, 'LVG.4.'))


# Set variables for protein and RNA expression levels
mRNA_expression <- CV0857_df$RNA.VST
protein_expression <- CV0857_df$Intensity
...
# Save 
ggsave('Figures/Expression_Plots/Untransformed/Linear_Regression_VST/CV0857_viridis_mRNAvsProtein_Expression_Plot_2024.09.21.pdf', plot = CV0857_plot, create.dir = T)
...
# Create new data frame for only the viridis samples
CV1086_df <- all_samples_plot_df %>% 
  filter(str_detect(Sample.ID, 'LVG.9.')) 


# Set variables for protein and RNA expression levels
mRNA_expression <- CV1086_df$RNA.VST
protein_expression <- CV1086_df$Intensity
...
# Save 
ggsave('Figures/Expression_Plots/Untransformed/Linear_Regression_VST/CV1086_viridis_mRNAvsProtein_Expression_Plot_2024.09.21.pdf', plot = CV1086_plot, create.dir = T)
...
# Create new data frame for only the viridis samples
CV1087_df <- all_samples_plot_df %>% 
  filter(str_detect(Sample.ID, 'RVG.5S.')) 


# Set variables for protein and RNA expression levels
mRNA_expression <- CV1087_df$RNA.VST
protein_expression <- CV1087_df$Intensity
...
# Save 
ggsave('Figures/Expression_Plots/Untransformed/Linear_Regression_VST/CV1087_viridis_mRNAvsProtein_Expression_Plot_2024.09.21.pdf', plot = CV1087_plot, create.dir = T)


#### mRNA vs Protein for CV0987 (lutosus) ####

# Create new data frame for only the viridis samples
CV0987_df <- all_samples_plot_df %>% 
  filter(str_detect(Sample.ID, 'RVG.6S.')) 


# Set variables for protein and RNA expression levels
mRNA_expression <- CV0987_df$RNA.VST
protein_expression <- CV0987_df$Intensity
...
# Save 
ggsave('Figures/Expression_Plots/Untransformed/Linear_Regression_VST/CV0987_lutosus_mRNAvsProtein_Expression_Plot_2024.09.21.pdf', plot = CV0987_plot, create.dir = T)
...
# Create new data frame for only the viridis samples
CV0985_df <- all_samples_plot_df %>% 
  filter(str_detect(Sample.ID, 'RVG.7S.')) 


# Set variables for protein and RNA expression levels
mRNA_expression <- CV0985_df$RNA.VST
protein_expression <- CV0985_df$Intensity
...
# Save 
ggsave('Figures/Expression_Plots/Untransformed/Linear_Regression_VST/CV0985_concolor_mRNAvsProtein_Expression_Plot_2024.09.21.pdf', plot = CV0985_plot, create.dir = T)
