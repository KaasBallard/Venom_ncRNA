...
# Run 3 or 4 times
chain <- 6
iter <- 20000 # Add a zero
thin <- 50 # Maybe make this at least 100 at least 500
warmup <- 7000
...
# Save 
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Model_Comparison_2024.10.19.pdf', plot = all_gene_expression_plot, height = 10, width = 10, create.dir = T)

# Add facet grid
all_gene_expression_plot2 <- all_gene_expression_plot + facet_wrap(~ Venom.Family)
all_gene_expression_plot2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_Model_Comparison_2024.10.19.pdf', plot = all_gene_expression_plot2, height = 15, width = 20, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model7_lm_2024.10.19.pdf', plot = all_gene_expression_plot_lm, height = 10, width = 10, create.dir = T)

# Add facet grid
all_gene_expression_plot_lm2 <- all_gene_expression_plot_lm + facet_wrap(~ Venom.Family)
all_gene_expression_plot_lm2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model7_lm_2024.10.19.pdf', plot = all_gene_expression_plot_lm2, height = 15, width = 20, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model2_lme_2024.10.19.pdf', plot = all_gene_expression_plot_lme, height = 10, width = 10, create.dir = T)

# Add facet grid
all_gene_expression_plot_lme2 <- all_gene_expression_plot_lme + facet_wrap(~ Venom.Family)
all_gene_expression_plot_lme2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model2_lme_2024.10.19.pdf', plot = all_gene_expression_plot_lme2, height = 15, width = 20, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model8_brm_2024.10.19.pdf', plot = all_gene_expression_plot_brm, height = 10, width = 10, create.dir = T)

# Add facet grid
all_gene_expression_plot_brm2 <- all_gene_expression_plot_brm + facet_wrap(~ Venom.Family)
all_gene_expression_plot_brm2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8_brm_2024.10.19.pdf', plot = all_gene_expression_plot_brm2, height = 15, width = 20, create.dir = T)
...
# Save 
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_microRNAvsProtein_Expression_Plot_2024.10.19.pdf', plot = Venom_Family_Specific_expression_plot, create.dir = T)
...
#  plots <- residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path, '2024.10.19', filter_r_squared = F)
# }
...
# for (gene in venom_genes) {
#  # Run the function in a loop
#  plots <- residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path2, '2024.10.19', filter_r_squared = T)
# }
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    ...
    residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path, '2024.10.19', filter_r_squared = FALSE)
    gc()
  }
}, mc.cores = num_cores)
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    # Run your plot function for each gene
    residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path2, '2024.10.19', filter_r_squared = TRUE)
    gc()
  }
}, mc.cores = num_cores)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Energy_vs_RSquared_Regressions_2024.10.19.pdf", plot = be_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Energy_vs_RSquared_Regressions_2024.10.19.pdf", plot = be_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, limitsize = F, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Score_vs_RSquared_Regressions_2024.10.19.pdf", plot = bs_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Score_vs_RSquared_Regressions_2024.10.19.pdf", plot = bs_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/RSquared_and_Binding_Score_2024.10.19.pdf", plot = r_squared_binding_score_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/RSquared_and_Binding_Energy_2024.10.19.pdf", plot = r_squared_binding_energy_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Filtered_RSquared_and_Binding_Energy_2024.10.19.pdf", plot = filtered_r_squared_binding_energy_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Filtered_RSquared_and_Binding_Score_2024.10.19.pdf", plot = filtered_r_squared_binding_score_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
R_squared_heatmap
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Heatmaps/Filtered_RSquared_Heatmap_(BS=160_BE=-20)_2024.10.19.pdf", plot = R_squared_heatmap, width = 10, height = 15, dpi = 900, create.dir = T)
...
write_csv3(max_scores_df2, file = 'Tables/Expression_Tables/Venom_Family_Specific_LM_BRM_LME/Top30_Best_miRNA-Gene_Pairs_2024.10.19.csv')
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Heatmaps/Filtered_RSquared_Heatmap_Best_30_2024.10.19.pdf", plot = R_squared_heatmap_best_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Top30_RSquared_and_Binding_Score_2024.10.19.pdf", plot = r_squared_binding_score_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Top30_RSquared_and_Binding_Energy_2024.10.19.pdf", plot = r_squared_binding_energy_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/Viridis_Only_Individuals_mRNAvsProtein_Expression_Plot_2024.10.19.pdf', plot = viridis_only_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/CV1081_viridis_mRNAvsProtein_Expression_Plot_2024.10.19.pdf', plot = CV1081_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/CV0857_viridis_mRNAvsProtein_Expression_Plot_2024.10.19.pdf', plot = CV0857_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/CV1086_viridis_mRNAvsProtein_Expression_Plot_2024.10.19.pdf', plot = CV1086_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/CV1087_viridis_mRNAvsProtein_Expression_Plot_2024.10.19.pdf', plot = CV1087_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/CV0987_lutosus_mRNAvsProtein_Expression_Plot_2024.10.19.pdf', plot = CV0987_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/CV0985_concolor_mRNAvsProtein_Expression_Plot_2024.10.19.pdf', plot = CV0985_plot, create.dir = T)
...
# Didn't work... at all
# Zero correlation
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/All_Individuals_mRNAvsmicroRNA_Expression_Plot_2024.10.19.pdf', plot = miRNA_vs_mRNA_all_samples_plot, create.dir = T)
...
figure_6
# ggsave("Figures/1_Main_Figures/Figure_6/Figure_6_2024.10.19.pdf", plot = figure_6, width = 18, height = 30, dpi = 2400, create.dir = T)
