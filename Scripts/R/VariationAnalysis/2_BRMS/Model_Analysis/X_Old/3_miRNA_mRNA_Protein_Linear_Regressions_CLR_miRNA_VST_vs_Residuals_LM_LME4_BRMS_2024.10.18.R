...
# Compare models
anova(venom_model1, venom_model2, venom_model3, venom_model4, venom_model5)
# > anova(venom_model1, venom_model2, venom_model3, venom_model4)
...
# ..1   24 736.58 811.55 -344.29   688.58                        
# ..2   24 686.00 760.98 -319.00   638.00 50.5742  0             
# ..3   25 688.00 766.10 -319.00   638.00  0.0055  1    0.94097  
# ..4   29 687.50 778.10 -314.75   629.50  8.4975  4    0.07496 .
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
AIC(venom_model1, venom_model2, venom_model3, venom_model4, venom_model5)
# > AIC(venom_model1, venom_model2, venom_model3, venom_model4)
# df      AIC
# venom_model1 24 664.3704
# venom_model2 24 603.5629
# venom_model3 25 605.5477
# venom_model4 29 596.7023
## Model 2 looks the best overall
...
## Extract brms venom_model6 information
# Summary
...
## Cool stuff from broom.mixed
# Get summary statistics
summary_stats_brm <- tidy(venom_model6)
# Get individual observations data
augment_brm <- augment(venom_model6)
# Model stats
glance_brm <- glance(venom_model6)

# Get predicted values
predictions_brm <- predict(venom_model6, newdata = all_samples_clr_df, re.form = NULL, se.fit = T) # The re.form = NULL means random effects are included, if you don't want to include them use re.form = NA which only uses fixed effects

# Extract fitted values and standard errors
fitted_values_brm <- predictions_brm$fit
se_fit_brm <- predictions_brm$se.fit

# Calculate confidence intervals
alpha <- 0.05  # For 95% confidence intervals
t_val_brm <- qt(1 - alpha / 2, df = df.residual(venom_model6))  # t-value for CI
ci_lower_brm <- fitted_values_brm - t_val_brm * se_fit_brm
ci_upper_brm <- fitted_values_brm + t_val_brm * se_fit_brm
...
all_samples_clr_df2 <- all_samples_clr_df %>% 
  mutate(
...
differences_df <- all_samples_clr_df2 %>% filter(abs(Fitted.lme - lme.fitted) > tolerance)
View(differences_df)
...
all_gene_expression_plot <- ggplot(data = all_samples_clr_df2, aes(x = CLR.Scaled.mRNA.Expression, y = CLR.Scaled.Protein.Expression, color = Venom.Family)) +
  geom_point(size = 2.5, alpha = 0.8) +
  # Add regression line from venom_model2
  geom_line(aes(y = .fitted), linewidth = 1, show.legend = F) +  # Add predicted lines
  # Add credible intervals
  geom_ribbon(aes(ymin = CI.Lower.lme, ymax = CI.Upper.lme, fill = Venom.Family), alpha = 0.2, show.legend = F) +  # Add credible intervals
  geom_smooth(
...
# Save 
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_2024.10.12.pdf', plot = all_gene_expression_plot, height = 10, width = 10, create.dir = T)

# Add facet grid
all_gene_expression_plot2 <- all_gene_expression_plot + facet_wrap(~ Venom.Family)
all_gene_expression_plot2
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_2024.10.12.pdf', plot = all_gene_expression_plot2, height = 15, width = 20, create.dir = T)
...
# Save 
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM/Linear_Regression_VST/All_Individuals_microRNAvsProtein_Expression_Plot_2024.10.12.pdf', plot = Venom_Family_Specific_expression_plot, create.dir = T)
...
path <- 'Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Residuals_Plots'

# # Loop the function
# for (gene in venom_genes) {
#  # Run the function in a loop
#  plots <- residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path, '2024.10.12', filter_r_squared = F)
# }


# Add only the plots with R squared higher than
# Create a second path
path2 <- 'Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Residuals_Plots/Good_R_squared'

# # Loop through the function
# for (gene in venom_genes) {
#  # Run the function in a loop
#  plots <- residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path2, '2024.10.12', filter_r_squared = T)
# }
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    ...
    residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path, '2024.10.12', filter_r_squared = FALSE)
    gc()
  }
}, mc.cores = num_cores)
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    # Run your plot function for each gene
    residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path2, '2024.10.12', filter_r_squared = TRUE)
    gc()
  }
}, mc.cores = num_cores)
...
# ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Energy_vs_RSquared_Regressions_2024.10.12.pdf", plot = be_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
# ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Energy_vs_RSquared_Regressions_2024.10.12.pdf", plot = be_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, limitsize = F, create.dir = T)
...
# ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Score_vs_RSquared_Regressions_2024.10.12.pdf", plot = bs_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
# ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Score_vs_RSquared_Regressions_2024.10.12.pdf", plot = bs_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, create.dir = T)
...
# ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Bubble_Plot/RSquared_and_Binding_Score_2024.10.12.pdf", plot = r_squared_binding_score_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
# ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Bubble_Plot/RSquared_and_Binding_Energy_2024.10.12.pdf", plot = r_squared_binding_energy_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
# ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Bubble_Plot/Filtered_RSquared_and_Binding_Energy_2024.10.12.pdf", plot = filtered_r_squared_binding_energy_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
# ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Bubble_Plot/Filtered_RSquared_and_Binding_Score_2024.10.12.pdf", plot = filtered_r_squared_binding_score_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
R_squared_heatmap
# ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Heatmaps/Filtered_RSquared_Heatmap_(BS=160_BE=-20)_2024.10.12.pdf", plot = R_squared_heatmap, width = 10, height = 15, dpi = 900, create.dir = T)
...
write.csv(max_scores_df2, 'Tables/Expression_Tables/Venom_Family_Specific_LM/Top30_Best_miRNA-Gene_Pairs_2024.10.12.csv', row.names = F)
...
# ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Heatmaps/Filtered_RSquared_Heatmap_Best_30_2024.10.12.pdf", plot = R_squared_heatmap_best_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
# ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Bubble_Plot/Top30_RSquared_and_Binding_Score_2024.10.12.pdf", plot = r_squared_binding_score_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
# ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM/Residuals/Bubble_Plot/Top30_RSquared_and_Binding_Energy_2024.10.12.pdf", plot = r_squared_binding_energy_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
# Save
# # ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM/miRNA_vs_Protein/Linear_Regression_VST/Viridis_Only_Individuals_mRNAvsProtein_Expression_Plot_2024.10.12.pdf', plot = viridis_only_plot, create.dir = T)
...
# Save
# # ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM/miRNA_vs_Protein/Linear_Regression_VST/CV1081_viridis_mRNAvsProtein_Expression_Plot_2024.10.12.pdf', plot = CV1081_plot, create.dir = T)
...
# Save
# # ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM/miRNA_vs_Protein/Linear_Regression_VST/CV0857_viridis_mRNAvsProtein_Expression_Plot_2024.10.12.pdf', plot = CV0857_plot, create.dir = T)
...
# Save
# # ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM/miRNA_vs_Protein/Linear_Regression_VST/CV1086_viridis_mRNAvsProtein_Expression_Plot_2024.10.12.pdf', plot = CV1086_plot, create.dir = T)
...
# Save
# # ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM/miRNA_vs_Protein/Linear_Regression_VST/CV1087_viridis_mRNAvsProtein_Expression_Plot_2024.10.12.pdf', plot = CV1087_plot, create.dir = T)
...
# Save
# # ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM/miRNA_vs_Protein/Linear_Regression_VST/CV0987_lutosus_mRNAvsProtein_Expression_Plot_2024.10.12.pdf', plot = CV0987_plot, create.dir = T)
...
# Save
# # ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM/miRNA_vs_Protein/Linear_Regression_VST/CV0985_concolor_mRNAvsProtein_Expression_Plot_2024.10.12.pdf', plot = CV0985_plot, create.dir = T)
...
# Didn't work... at all
# Zero correlation
# # ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM/miRNA_vs_Protein/Linear_Regression_VST/All_Individuals_mRNAvsmicroRNA_Expression_Plot_2024.10.12.pdf', plot = miRNA_vs_mRNA_all_samples_plot, create.dir = T)
...
figure_6
# # ggsave("Figures/1_Main_Figures/Figure_6/Figure_6_2024.10.12.pdf", plot = figure_6, width = 18, height = 30, dpi = 2400, create.dir = T)
