...
mismatched_samples <- setdiff(all_samples_clr_df$Sample.ID, tree_tips)
...
## Uncomment this if you need to rerun it.
# Set brms model parameters
# Run 3 or 4 times
warmup_percentage <- 0.5 # Set the percent to be kept by the model
chain <- 6
iter <- 5000000 # Add a zero
thin <- 100 # make this at least 100 at least 500
...
# Save model so I don't have to redo it each time:
saveRDS(venom_model8.1, file = "Data/Models/venom_model8.1_from_brms_2024.10.25.rds")

# Load the saved model
venom_model8.1 <- readRDS("Data/Models/venom_model8.1_from_brms_2024.10.25.rds")
...
# ..7   23 734.58 806.43 -344.29   688.58                          
# ..1   24 736.58 811.55 -344.29   688.58  0.0000  1      1.000    
# ..2   24 686.00 760.98 -319.00   638.00 50.5742  0               
# ..3   25 688.00 766.10 -319.00   638.00  0.0055  1      0.941    
# ..5   28 739.61 827.08 -341.81   683.61  0.0000  3      1.000    
# ..4   29 687.50 778.10 -314.75   629.50 54.1112  1  1.895e-13 ***
#   ..6   40 633.19 758.15 -276.60   553.19 76.3065 11  7.606e-12 ***
#   ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
AIC(venom_model1, venom_model2, venom_model3, venom_model4, venom_model5, venom_model6, venom_model7)
# > AIC(venom_model1, venom_model2, venom_model3, venom_model4, venom_model5, venom_model6, venom_model7)
# df      AIC
# venom_model1 24 664.3704
# venom_model2 24 603.5629
# venom_model3 25 605.5477
# venom_model4 29 596.7023
# venom_model5 28 739.6123
# venom_model6 40 633.1945
# venom_model7 23 734.5782
waic(venom_model8.1)
# > waic(venom_model8.1)
# 
# Computed from 1560 by 168 log-likelihood matrix.
# 
# Estimate   SE
# elpd_waic   -367.8 14.7
# p_waic        18.9  3.3
# waic         735.5 29.4
# 
# 8 (4.8%) p_waic estimates greater than 0.4. We recommend trying loo instead. 
...
summary_stats_lme <- tidy(venom_model2)
# Get individual observations data
augment_lme <- augment(venom_model2) %>%
  rename_with(
    .cols = starts_with("."), .fn = ~ gsub("^\\.", "lme.", .)
  )

# Model stats
glance_lme <- glance(venom_model2)

# Get predicted values
predictions_lme <- predict(venom_model2, newdata = all_samples_clr_df, re.form = NULL, se.fit = T) # The re.form = NULL means random effects are included, if you don't want to include them use re.form = NA which only uses fixed effects
...
shared_names_lme <- intersect(names(augment_lme), names(all_samples_clr_df))

# Add confidene intervals and fitted values
all_samples_clr_lme_df <- all_samples_clr_df %>%
  mutate(
...
# Get summary statistics
summary_stats_lm <- tidy(venom_model7)

# Get individual observations data
augment_lm <- augment(venom_model7) %>%
  rename_with(
    .cols = starts_with("."), .fn = ~ gsub("^\\.", "lm.", .)
  )

# Model stats
glance_lm <- glance(venom_model7)

# Get predicted values
predictions_lm <- predict(venom_model7, newdata = all_samples_clr_df, re.form = NA, se.fit = T, interval = 'confidence') # The re.form = NULL means random effects are included, if you don't want to include them use re.form = NA which only uses fixed effects
...
# Create shared names set
shared_names_lm <- intersect(names(augment_lm), names(all_samples_clr_df))

# Add confidene intervals and fitted values
all_samples_clr_lm_df <- all_samples_clr_df %>%
  mutate(
...
## Extract brms venom_model8.1 information
# Summary
model8_summary <- summary(venom_model8.1)
print(model8_summary)

# Cool stuff from broom.mixed
# Get summary statistics
summary_stats_brm <- tidy(venom_model8.1)
# Get individual observations data
augment_brm <- augment(venom_model8.1) %>%
  rename_with(
    .cols = starts_with("."), .fn = ~ gsub("^\\.", "brm.", .)
  )

# Model stats
glance_brm <- glance(venom_model8.1)

# Get predicted values
predictions_brm <- predict(venom_model8.1, newdata = all_samples_clr_df, re.form = NULL, se.fit = T) # The re.form = NULL means random effects are included, if you don't want to include them use re.form = NA which only uses fixed effects
...
# Create shared names set
shared_names_brm <- intersect(names(augment_brm), names(all_samples_clr_df))

# Add confidene intervals and fitted values
all_samples_clr_brm_df <- all_samples_clr_df %>%
  mutate(
...
all_gene_expression_plot <- ggplot(data = all_samples_clr_df, aes(x = CLR.Scaled.mRNA.Expression, y = CLR.Scaled.Protein.Expression, color = Venom.Family)) +
  ...
  # Add credible intervals for venom_model8.1
...
# Save
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Model_Comparison_2024.10.25.pdf', plot = all_gene_expression_plot, height = 10, width = 10, create.dir = T)

# Add facet grid
all_gene_expression_plot2 <- all_gene_expression_plot + facet_wrap(~ Venom.Family)
all_gene_expression_plot2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_Model_Comparison_2024.10.25.pdf', plot = all_gene_expression_plot2, height = 15, width = 20, create.dir = T)
...
# Save
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model7_lm_2024.10.25.pdf', plot = all_gene_expression_plot_lm, height = 10, width = 10, create.dir = T)

# Add facet grid
all_gene_expression_plot_lm2 <- all_gene_expression_plot_lm + facet_wrap(~ Venom.Family)
all_gene_expression_plot_lm2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model7_lm_2024.10.25.pdf', plot = all_gene_expression_plot_lm2, height = 15, width = 20, create.dir = T)
...
# Save
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model2_lme_2024.10.25.pdf', plot = all_gene_expression_plot_lme, height = 10, width = 10, create.dir = T)

# Add facet grid
all_gene_expression_plot_lme2 <- all_gene_expression_plot_lme + facet_wrap(~ Venom.Family)
all_gene_expression_plot_lme2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model2_lme_2024.10.25.pdf', plot = all_gene_expression_plot_lme2, height = 15, width = 20, create.dir = T)
...
# Save
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model8.1_brm_2024.10.25.pdf', plot = all_gene_expression_plot_brm, height = 10, width = 10, create.dir = T)

# Add facet grid
all_gene_expression_plot_brm2 <- all_gene_expression_plot_brm + facet_wrap(~ Venom.Family)
all_gene_expression_plot_brm2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8.1_brm_2024.10.25.pdf', plot = all_gene_expression_plot_brm2, height = 15, width = 20, create.dir = T)
...
all_samples_clr_brm_epred_df <- all_samples_clr_df %>%
  ...
  tidybayes::add_epred_draws(venom_model8.1, ndraws = ndraws1)
...
all_gene_expression_plot_brm_epred <- ggplot(data = all_samples_clr_df, aes(x = CLR.Scaled.mRNA.Expression, y = CLR.Scaled.Protein.Expression, color = Venom.Family)) +
  geom_point(aes(shape = Species), size = 2.5, alpha = 0.8) +
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model8.1_brm_epred_2024.10.25.pdf', plot = all_gene_expression_plot_brm_epred, height = 15, width = 20, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8.1_brm_epred_2024.10.25.pdf', plot = all_gene_expression_plot_brm_epred2, height = 15, width = 20, create.dir = T)
...
# anim_save('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8.1_brm_epred_animated_2024.10.25.gif', animation = all_gene_expression_plot_brm_epred4, create.dir = T)
...
all_samples_clr_brm_prediction_df <- all_samples_clr_df %>%
  ...
  tidybayes::add_predicted_draws(venom_model8.1, ndraws = ndraws2)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model8.1_brm_prediction_2024.10.25.pdf', plot = all_gene_expression_plot_brm_pred, height = 15, width = 20, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8.1_brm_prediction_2024.10.25.pdf', plot = all_gene_expression_plot_brm_pred2, height = 15, width = 20, create.dir = T)


# Create another figure for mRNA and Protein expression for the simple brms model (venom_model8.1) with averaged predicted values
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model8.1_brm_mean_prediction_2024.10.25.pdf', plot = all_gene_expression_plot_brm_mean_pred, height = 15, width = 20, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8.1_brm_mean_prediction_2024.10.25.pdf', plot = all_gene_expression_plot_brm_mean_pred2, height = 15, width = 20, create.dir = T)
...
# Save
ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Linear_Regression_VST/All_Individuals_microRNAvsProtein_Expression_Plot_2024.10.25.pdf', plot = Venom_Family_Specific_expression_plot, create.dir = T)
...
#  plots <- residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path, '2024.10.25', filter_r_squared = F)
# }
...
# for (gene in venom_genes) {
#  # Run the function in a loop
#  plots <- residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path2, '2024.10.25', filter_r_squared = T)
# }
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    ...
    residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path, '2024.10.25', filter_r_squared = FALSE)
    gc()
  }
}, mc.cores = num_cores)
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    # Run your plot function for each gene
    residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path2, '2024.10.25', filter_r_squared = TRUE)
    gc()
  }
}, mc.cores = num_cores)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Energy_vs_RSquared_Regressions_2024.10.25.pdf", plot = be_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Energy_vs_RSquared_Regressions_2024.10.25.pdf", plot = be_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, limitsize = F, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Score_vs_RSquared_Regressions_2024.10.25.pdf", plot = bs_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Score_vs_RSquared_Regressions_2024.10.25.pdf", plot = bs_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/RSquared_and_Binding_Score_2024.10.25.pdf", plot = r_squared_binding_score_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/RSquared_and_Binding_Energy_2024.10.25.pdf", plot = r_squared_binding_energy_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Filtered_RSquared_and_Binding_Energy_2024.10.25.pdf", plot = filtered_r_squared_binding_energy_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Filtered_RSquared_and_Binding_Score_2024.10.25.pdf", plot = filtered_r_squared_binding_score_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
R_squared_heatmap
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Heatmaps/Filtered_RSquared_Heatmap_(BS=160_BE=-20)_2024.10.25.pdf", plot = R_squared_heatmap, width = 10, height = 15, dpi = 900, create.dir = T)
...
write_csv3(max_scores_df2, file = 'Tables/Expression_Tables/Venom_Family_Specific_LM_BRM_LME/Top30_Best_miRNA-Gene_Pairs_2024.10.25.csv')
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Heatmaps/Filtered_RSquared_Heatmap_Best_30_2024.10.25.pdf", plot = R_squared_heatmap_best_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Top30_RSquared_and_Binding_Score_2024.10.25.pdf", plot = r_squared_binding_score_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/Residuals/Bubble_Plot/Top30_RSquared_and_Binding_Energy_2024.10.25.pdf", plot = r_squared_binding_energy_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/Viridis_Only_Individuals_mRNAvsProtein_Expression_Plot_2024.10.25.pdf', plot = viridis_only_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/CV1081_viridis_mRNAvsProtein_Expression_Plot_2024.10.25.pdf', plot = CV1081_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/CV0857_viridis_mRNAvsProtein_Expression_Plot_2024.10.25.pdf', plot = CV0857_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/CV1086_viridis_mRNAvsProtein_Expression_Plot_2024.10.25.pdf', plot = CV1086_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/CV1087_viridis_mRNAvsProtein_Expression_Plot_2024.10.25.pdf', plot = CV1087_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/CV0987_lutosus_mRNAvsProtein_Expression_Plot_2024.10.25.pdf', plot = CV0987_plot, create.dir = T)
...
# Save
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/CV0985_concolor_mRNAvsProtein_Expression_Plot_2024.10.25.pdf', plot = CV0985_plot, create.dir = T)
...
# Didn't work... at all
# Zero correlation
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_LM_BRM_LME/miRNA_vs_Protein/Linear_Regression_VST/All_Individuals_mRNAvsmicroRNA_Expression_Plot_2024.10.25.pdf', plot = miRNA_vs_mRNA_all_samples_plot, create.dir = T)
...
figure_6
# ggsave("Figures/1_Main_Figures/Figure_6/Figure_6_2024.10.25.pdf", plot = figure_6, width = 18, height = 30, dpi = 2400, create.dir = T)
