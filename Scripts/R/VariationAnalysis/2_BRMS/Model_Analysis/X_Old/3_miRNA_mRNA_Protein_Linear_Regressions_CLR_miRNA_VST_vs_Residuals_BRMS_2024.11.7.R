...
# CLR file
clr_data <- 'Data/CLR_transformed_data/CLR_mRNA_vs_protein_expression_2024.11.7.csv'

# miRNA, mRNA, protein file
mirna_mrna_protein_file <- 'Data/miRNA/miRNA_mRNA_protein_data_for_regression_analysis_2024.11.7.csv'

# CLR data, with miRNA data
miRNA_clr_data <- 'Data/CLR_transformed_data/CLR_mRNA_vs_protein_with_miRNA_expression_2024.11.7.csv'
...
venom_model8 <- readRDS("Data/Models/mRNAvsProtein/venom_model8_with_500000_iterations_from_brms_2024.11.7.rds")

# Load models that includes miRNAs in the modeling
venom_model9 <- readRDS('Data/Models/With_miRNA/venom_model9_with_25000_iterations_from_brms_2024.11.7.rds')
venom_model10 <- readRDS('Data/Models/With_miRNA/venom_model10_with_25000_iterations_from_brms_2024.11.7.rds')
venom_model11 <- readRDS('Data/Models/With_miRNA/venom_model11_with_25000_iterations_from_brms_2024.11.7.rds')
venom_model12 <- readRDS('Data/Models/With_miRNA/venom_model12_with_25000_iterations_from_brms_2024.11.7.rds')
venom_model13 <- readRDS('Data/Models/With_miRNA/venom_model13_with_25000_iterations_from_brms_2024.11.7.rds')
...
waic(venom_model9, venom_model10, venom_model11, venom_model12, venom_model13)
...
add_loo(venom_model13)


# Run loo
loo(venom_model9, venom_model10, venom_model11, venom_model12, venom_model13, moment_match = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_venom_model8_brm_epred_2024.11.7.png', plot = all_gene_expression_plot_brm_epred, height = 15, width = 20, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8_brm_epred_2024.11.7.png', plot = all_gene_expression_plot_brm_epred2, height = 15, width = 20, create.dir = T)
...
# anim_save('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_Individual_Families_venom_model8_brm_epred_animated_2024.11.7.gif', animation = all_gene_expression_plot_brm_epred4, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_With_BRM_Epred_Method_venom_model8_2024.11.7.png', plot = all_gene_expression_epred_plot, height = 15, width = 20, create.dir = T)

# Add facet wrap
all_gene_expression_epred_plot2 <- all_gene_expression_epred_plot + facet_wrap(~ Venom.Family)
all_gene_expression_epred_plot2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_With_BRM_Epred_Method_Separated_by_Venom_Family_venom_model8_2024.11.7.png', plot = all_gene_expression_epred_plot2, height = 15, width = 20, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_With_BRM_Mean_Epred_Method_venom_model8_2024.11.7.pdf', plot = all_gene_expression_mean_epred_plot, height = 15, width = 20, create.dir = T)
...
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_mRNAvsProtein_Expression_Plot_With_BRM_Mean_Epred_Method_Separated_by_Venom_Family_venom_model8_2024.11.7.png', plot = all_gene_expression_mean_epred_plot2, height = 15, width = 20, create.dir = T)
...
# Save
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/Linear_Regression_VST/All_Individuals_microRNAvsProtein_Expression_Plot_2024.11.7.pdf', plot = venom_family_specific_expression_plot, create.dir = T)
...
names2 <- intersect(names(miRNA_RNA_protein_plot_df %>% select(-RNA.Raw.Counts, -contains('Max.'))), names(all_samples_clr_df))
...
all_samples_residuals_miRNA_df <- left_join(
  ...
  left_join(
    miRNA_RNA_protein_plot_df %>% select(-RNA.Raw.Counts, -contains('Max.')),
    by = names2
  ) %>% 
...
#  plots <- residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path, '2024.11.7', filter_r_squared = F)
# }
...
# for (gene in venom_genes) {
#  # Run the function in a loop
#  plots <- residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path2, '2024.11.7', filter_r_squared = T)
# }
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    ...
    residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path, '2024.11.7', filter_r_squared = FALSE)
    gc()
  }
}, mc.cores = num_cores)
...
mclapply(gene_batches, function(gene_batch) {
  for (gene in gene_batch) {
    # Run your plot function for each gene
    residuals_vs_miRNA_plot2(wider_all_samples_residuals_miRNA_df, gene, path2, '2024.11.7', filter_r_squared = TRUE)
    gc()
  }
}, mc.cores = num_cores)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Energy_vs_RSquared_Regressions_2024.11.7.pdf", plot = be_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Energy_vs_RSquared_Regressions_2024.11.7.pdf", plot = be_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, limitsize = F, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/miRNA_Binding_Score_vs_RSquared_Regressions_2024.11.7.pdf", plot = bs_vs_r_squared_plot, width = 10, height = 10, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Binding_Data_vs_RSquared/Labeled/Labeled_miRNA_Binding_Score_vs_RSquared_Regressions_2024.11.7.pdf", plot = bs_vs_r_squared_plot2, width = 25, height = 25, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/RSquared_and_Binding_Score_2024.11.7.pdf", plot = r_squared_binding_score_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/RSquared_and_Binding_Energy_2024.11.7.pdf", plot = r_squared_binding_energy_bubble_plot, width = 15, height = 28, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Filtered_RSquared_and_Binding_Energy_2024.11.7.pdf", plot = filtered_r_squared_binding_energy_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Filtered_RSquared_and_Binding_Score_2024.11.7.pdf", plot = filtered_r_squared_binding_score_bubble_plot, width = 10, height = 15, dpi = 900, create.dir = T)
...
R_squared_heatmap
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Heatmaps/Filtered_RSquared_Heatmap_(BS=160_BE=-20)_2024.11.7.pdf", plot = R_squared_heatmap, width = 10, height = 15, dpi = 900, create.dir = T)
...
write_csv3(max_scores_df2, file = 'Tables/Expression_Tables/Venom_Family_Specific_BRM/Top30_Best_miRNA-Gene_Pairs_2024.11.7.csv')
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Heatmaps/Filtered_RSquared_Heatmap_Best_30_2024.11.7.pdf", plot = R_squared_heatmap_best_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Top30_RSquared_and_Binding_Score_2024.11.7.pdf", plot = r_squared_binding_score_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
ggsave("Figures/Expression_Plots/Venom_Family_Specific_BRM/Residuals/Bubble_Plot/Top30_RSquared_and_Binding_Energy_2024.11.7.pdf", plot = r_squared_binding_energy_bubble_plot_top_30, width = 10, height = 15, dpi = 900, create.dir = T)
...
# Didn't work... at all
# Zero correlation
# ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_vs_Protein/Linear_Regression_VST/All_Individuals_mRNAvsmicroRNA_Expression_Plot_2024.11.7.pdf', plot = miRNA_vs_mRNA_all_samples_plot, create.dir = T)
...
miRNA_clr_df <- read.csv(miRNA_clr_data)
...
venom_model9_plot
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_modeling/venom_model9_plot_2024.11.7.png', plot = venom_model9_plot, height = 15, width = 20, create.dir = T)

# Add facet wrap
venom_model9_plot2 <- venom_model9_plot + facet_wrap(~ Venom.Family)
venom_model9_plot2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_modeling/venom_model9_plot_individual_families_2024.11.7.png', plot = venom_model9_plot2, height = 15, width = 20, create.dir = T)
...
venom_model10_plot
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_modeling/venom_model10_plot_2024.11.7.png', plot = venom_model10_plot, height = 15, width = 20, create.dir = T)

# Add facet wrap
venom_model10_plot2 <- venom_model10_plot + facet_wrap(~ Venom.Family)
venom_model10_plot2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_modeling/venom_model10_plot_individual_families_2024.11.7.png', plot = venom_model10_plot2, height = 15, width = 20, create.dir = T)
...
venom_model11_plot
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_modeling/venom_model11_plot_2024.11.7.png', plot = venom_model11_plot, height = 15, width = 20, create.dir = T)

# Add facet wrap
venom_model11_plot2 <- venom_model11_plot + facet_wrap(~ Venom.Family)
venom_model11_plot2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_modeling/venom_model11_plot_individual_families_2024.11.7.png', plot = venom_model11_plot2, height = 15, width = 20, create.dir = T)
...
venom_model12_plot
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_modeling/venom_model12_plot_2024.11.7.png', plot = venom_model12_plot, height = 15, width = 20, create.dir = T)

# Add facet wrap
venom_model12_plot2 <- venom_model12_plot + facet_wrap(~ Venom.Family)
venom_model12_plot2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_modeling/venom_model12_plot_individual_families_2024.11.7.png', plot = venom_model12_plot2, height = 15, width = 20, create.dir = T)
...
# Create a data frame to hold the R^2 values
tidy_13_r_squared_df <- miRNA_clr_detected_proteins_only_df %>% 
  select(
    -RNA.Raw.Counts, -Intensity, -Scaled.Protein.Expression, -Scaled.mRNA.Expression
  ) %>%
  # Epreds are expected values of the response variable that don't include observation noise
...
venom_model13_plot <- ggplot(data = miRNA_clr_df, aes(x = CLR.Scaled.mRNA.Expression, y = CLR.Scaled.Protein.Expression, color = Venom.Family)) +
...
venom_model13_plot
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_modeling/venom_model13_plot_2024.11.7.png', plot = venom_model13_plot, height = 15, width = 20, create.dir = T)

# Add facet wrap
venom_model13_plot2 <- venom_model13_plot + facet_wrap(~ Venom.Family)
venom_model13_plot2
ggsave('Figures/Expression_Plots/Venom_Family_Specific_BRM/miRNA_modeling/venom_model13_plot_individual_families_2024.11.7.png', plot = venom_model13_plot2, height = 15, width = 20, create.dir = T)
...
figure_6
ggsave("Figures/1_Main_Figures/Figure_6/Figure_6_2024.11.7.png", plot = figure_6, width = 18, height = 35, dpi = 900, create.dir = T)
